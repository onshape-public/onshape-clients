...
------------- | ------------- | -------------
[**documents_copy_workspace**](DefaultApi.md#documents_copy_workspace) | **POST** /documents/{did}/workspaces/{wid}/copy | Copy Workspace
[**documents_create_document**](DefaultApi.md#documents_create_document) | **POST** /documents | Create Document
[**documents_create_version**](DefaultApi.md#documents_create_version) | **POST** /documents/d/{did}/versions | Create Version
[**documents_create_workspace**](DefaultApi.md#documents_create_workspace) | **POST** /documents/d/{did}/workspaces | Create Workspace
[**documents_delete_document**](DefaultApi.md#documents_delete_document) | **DELETE** /documents/{did} | Delete Document
[**documents_delete_workspace**](DefaultApi.md#documents_delete_workspace) | **DELETE** /documents/d/{did}/workspaces/{wid} | Delete Workspace
[**documents_download_external_data**](DefaultApi.md#documents_download_external_data) | **GET** /documents/d/{did}/externaldata/{fid} | Download External Data
[**documents_export_element**](DefaultApi.md#documents_export_element) | **GET** /documents/d/{did}/{wv_char}/{wv}/e/{eid}/export | Export Element (307)
[**documents_export_element_post_json**](DefaultApi.md#documents_export_element_post_json) | **POST** /documents/d/{did}/{wv_char}/{wv}/e/{eid}/export | Export Element (URI)
[**documents_get_acl**](DefaultApi.md#documents_get_acl) | **GET** /documents/{did}/acl | Get Access Control List
[**documents_get_current_microversion**](DefaultApi.md#documents_get_current_microversion) | **GET** /documents/d/{did}/{wv_char}/{wv}/currentmicroversion | Get Current Document Microversion
[**documents_get_document**](DefaultApi.md#documents_get_document) | **GET** /documents/{did} | Get Document
[**documents_get_document_permission_set**](DefaultApi.md#documents_get_document_permission_set) | **GET** /documents/{did}/permissionset | Get Document Permissions
[**documents_get_documents**](DefaultApi.md#documents_get_documents) | **GET** /documents | Get Documents
[**documents_get_element_list**](DefaultApi.md#documents_get_element_list) | **GET** /documents/d/{did}/{wvm_char}/{wvm}/elements | Element List
[**documents_get_insertables**](DefaultApi.md#documents_get_insertables) | **GET** /documents/d/{did}/v/{vid}/insertables | Insertable List for Document Version.
[**documents_get_version**](DefaultApi.md#documents_get_version) | **GET** /documents/d/{did}/versions/{vid} | Get Version
[**documents_get_versions**](DefaultApi.md#documents_get_versions) | **GET** /documents/d/{did}/versions | Get Versions
[**documents_get_workspaces**](DefaultApi.md#documents_get_workspaces) | **GET** /documents/d/{did}/workspaces | Get Workspaces
[**documents_move_elements_to_document**](DefaultApi.md#documents_move_elements_to_document) | **POST** /documents/d/{did}/w/{wid}/moveelement | Move Elements
[**documents_share_document**](DefaultApi.md#documents_share_document) | **POST** /documents/{did}/share | Share Document
[**documents_un_share**](DefaultApi.md#documents_un_share) | **DELETE** /documents/{did}/share/{eid} | Unshare Document
[**documents_update_document_attributes**](DefaultApi.md#documents_update_document_attributes) | **POST** /documents/{did} | Update Document Attributes.
[**documents_update_external_references_to_latest_documents**](DefaultApi.md#documents_update_external_references_to_latest_documents) | **POST** /documents/d/{did}/w/{wid}/e/{eid}/latestdocumentreferences | Update External References to Latest


# **documents_copy_workspace**
> DocumentsCopyWorkspaceResponse200 documents_copy_workspace(did, wid, body=body)
...
body = swagger_client.DocumentsCopyWorkspaceBody() # DocumentsCopyWorkspaceBody | The JSON request body. (optional)

try:
    # Copy Workspace
    api_response = api_instance.documents_copy_workspace(did, wid, body=body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_copy_workspace: %s\n" % e)
```
...
> DocumentsCreateDocumentResponse200 documents_create_document(body=body)
...
# create an instance of the API class
api_instance = swagger_client.DefaultApi(swagger_client.ApiClient(configuration))
body = swagger_client.DocumentsCreateDocumentBody() # DocumentsCreateDocumentBody | The JSON request body. (optional)

try:
    # Create Document
    api_response = api_instance.documents_create_document(body=body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_create_document: %s\n" % e)
```
...
# **documents_create_version**
> DocumentsCreateVersionResponse200 documents_create_version(did, body=body)
...
api_instance = swagger_client.DefaultApi(swagger_client.ApiClient(configuration))
did = 'did_example' # str | Document ID
body = swagger_client.DocumentsCreateVersionBody() # DocumentsCreateVersionBody | The JSON request body. (optional)

try:
    # Create Version
    api_response = api_instance.documents_create_version(did, body=body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_create_version: %s\n" % e)
```
...
# **documents_create_workspace**
> DocumentsCreateWorkspaceResponse200 documents_create_workspace(did, body=body)
...
api_instance = swagger_client.DefaultApi(swagger_client.ApiClient(configuration))
did = 'did_example' # str | Document ID
body = swagger_client.DocumentsCreateWorkspaceBody() # DocumentsCreateWorkspaceBody | The JSON request body. (optional)

try:
    # Create Workspace
    api_response = api_instance.documents_create_workspace(did, body=body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_create_workspace: %s\n" % e)
```
...
try:
    # Delete Document
    api_instance.documents_delete_document(did)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_delete_document: %s\n" % e)
```
...
# **documents_delete_workspace**
> documents_delete_workspace(did, wid)
...
try:
    # Delete Workspace
    api_instance.documents_delete_workspace(did, wid)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_delete_workspace: %s\n" % e)
```
...
# **documents_download_external_data**
> file documents_download_external_data(fid, did)
...
try:
    # Download External Data
    api_response = api_instance.documents_download_external_data(fid, did)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_download_external_data: %s\n" % e)
```
...
# **documents_export_element**
> file documents_export_element(wv_char, format, scale, mode, did, wv, eid, store_in_document=store_in_document, link_document_workspace_id=link_document_workspace_id, part_ids=part_ids, microversion=microversion, grouping=grouping, zip_single_file_output=zip_single_file_output, units=units, angle_tolerance=angle_tolerance, chord_tolerance=chord_tolerance, max_facet_width=max_facet_width, min_facet_width=min_facet_width, version=version, link_document_id=link_document_id)
...
try:
    # Export Element (307)
    api_response = api_instance.documents_export_element(wv_char, format, scale, mode, did, wv, eid, store_in_document=store_in_document, link_document_workspace_id=link_document_workspace_id, part_ids=part_ids, microversion=microversion, grouping=grouping, zip_single_file_output=zip_single_file_output, units=units, angle_tolerance=angle_tolerance, chord_tolerance=chord_tolerance, max_facet_width=max_facet_width, min_facet_width=min_facet_width, version=version, link_document_id=link_document_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_export_element: %s\n" % e)
```
...
# **documents_export_element_post_json**
> DocumentsExportElementPostJsonResponse200 documents_export_element_post_json(wv_char, did, wv, eid, body=body, link_document_id=link_document_id)
...
wv = 'wv_example' # str | Workspace (w) or Version (v) ID
eid = 'eid_example' # str | Element ID
body = swagger_client.DocumentsExportElementPostJsonBody() # DocumentsExportElementPostJsonBody | The JSON request body. (optional)
link_document_id = 'link_document_id_example' # str | Id of document that links to the document being accessed.     This may provide additional access rights to the document. Allowed only with version (v) path parameter. (optional)

try:
    # Export Element (URI)
    api_response = api_instance.documents_export_element_post_json(wv_char, did, wv, eid, body=body, link_document_id=link_document_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_export_element_post_json: %s\n" % e)
```
...
# **documents_get_acl**
> DocumentsGetAclResponse200 documents_get_acl(did)
...
try:
    # Get Access Control List
    api_response = api_instance.documents_get_acl(did)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_get_acl: %s\n" % e)
```
...
# **documents_get_current_microversion**
> DocumentsGetCurrentMicroversionResponse200 documents_get_current_microversion(wv_char, did, wv)
...
try:
    # Get Current Document Microversion
    api_response = api_instance.documents_get_current_microversion(wv_char, did, wv)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_get_current_microversion: %s\n" % e)
```
...
> DocumentsGetDocumentResponse200 documents_get_document(did)
...
try:
    # Get Document
    api_response = api_instance.documents_get_document(did)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_get_document: %s\n" % e)
```
...
# **documents_get_document_permission_set**
> documents_get_document_permission_set(did)
...
try:
    # Get Document Permissions
    api_instance.documents_get_document_permission_set(did)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_get_document_permission_set: %s\n" % e)
```
...
> DocumentsGetDocumentsResponse200 documents_get_documents(q=q, filter=filter, owner=owner, owner_type=owner_type, sort_column=sort_column, sort_order=sort_order, offset=offset, limit=limit)
...
try:
    # Get Documents
    api_response = api_instance.documents_get_documents(q=q, filter=filter, owner=owner, owner_type=owner_type, sort_column=sort_column, sort_order=sort_order, offset=offset, limit=limit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_get_documents: %s\n" % e)
```
...
# **documents_get_element_list**
> DocumentsGetElementListResponse200 documents_get_element_list(wvm_char, did, wvm, element_type=element_type, element_id=element_id, with_thumbnails=with_thumbnails)
...
try:
    # Element List
    api_response = api_instance.documents_get_element_list(wvm_char, did, wvm, element_type=element_type, element_id=element_id, with_thumbnails=with_thumbnails)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_get_element_list: %s\n" % e)
```
...
try:
    # Insertable List for Document Version.
    api_response = api_instance.documents_get_insertables(did, vid, beta_capability_ids=beta_capability_ids, include_parts=include_parts, include_surfaces=include_surfaces, include_wires=include_wires, include_sketches=include_sketches, include_reference_features=include_reference_features, include_assemblies=include_assemblies, include_feature_studios=include_feature_studios, include_features=include_features, include_blobs=include_blobs, include_meshes=include_meshes, include_flattened_bodies=include_flattened_bodies, include_applications=include_applications, allowed_blob_mime_types=allowed_blob_mime_types, allowed_application_mime_types=allowed_application_mime_types, max_feature_script_version=max_feature_script_version)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_get_insertables: %s\n" % e)
```
...
# **documents_get_version**
> DocumentsGetVersionResponse200 documents_get_version(did, vid, link_document_id=link_document_id)
...
try:
    # Get Version
    api_response = api_instance.documents_get_version(did, vid, link_document_id=link_document_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_get_version: %s\n" % e)
```
...
> DocumentsGetVersionsResponse200 documents_get_versions(did, offset=offset, limit=limit)
...
try:
    # Get Versions
    api_response = api_instance.documents_get_versions(did, offset=offset, limit=limit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_get_versions: %s\n" % e)
```
...
# **documents_get_workspaces**
> DocumentsGetWorkspacesResponse200 documents_get_workspaces(did, noreadonly=noreadonly)
...
try:
    # Get Workspaces
    api_response = api_instance.documents_get_workspaces(did, noreadonly=noreadonly)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_get_workspaces: %s\n" % e)
```
...
# **documents_move_elements_to_document**
> DocumentsMoveElementsToDocumentResponse200 documents_move_elements_to_document(did, wid, body=body)
...
did = 'did_example' # str | Document ID
wid = 'wid_example' # str | Workspace ID
body = swagger_client.DocumentsMoveElementsToDocumentBody() # DocumentsMoveElementsToDocumentBody | The JSON request body. (optional)

try:
    # Move Elements
    api_response = api_instance.documents_move_elements_to_document(did, wid, body=body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_move_elements_to_document: %s\n" % e)
```
...
# **documents_share_document**
> DocumentsShareDocumentResponse200 documents_share_document(did, body=body)
...
api_instance = swagger_client.DefaultApi(swagger_client.ApiClient(configuration))
did = 'did_example' # str | Document ID
body = swagger_client.DocumentsShareDocumentBody() # DocumentsShareDocumentBody | The JSON request body. (optional)

try:
    # Share Document
    api_response = api_instance.documents_share_document(did, body=body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_share_document: %s\n" % e)
```
...
# **documents_un_share**
> documents_un_share(eid, did, entry_type=entry_type)
...
try:
    # Unshare Document
    api_instance.documents_un_share(eid, did, entry_type=entry_type)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_un_share: %s\n" % e)
```
...
# **documents_update_document_attributes**
> documents_update_document_attributes(did, body=body)
...
api_instance = swagger_client.DefaultApi(swagger_client.ApiClient(configuration))
did = 'did_example' # str | Document ID
body = swagger_client.DocumentsUpdateDocumentAttributesBody() # DocumentsUpdateDocumentAttributesBody | The JSON request body. (optional)

try:
    # Update Document Attributes.
    api_instance.documents_update_document_attributes(did, body=body)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_update_document_attributes: %s\n" % e)
```
...
# **documents_update_external_references_to_latest_documents**
> DocumentsUpdateExternalReferencesToLatestDocumentsResponse200 documents_update_external_references_to_latest_documents(did, wid, eid, body=body)
...
wid = 'wid_example' # str | Workspace ID
eid = 'eid_example' # str | Element ID
body = swagger_client.DocumentsUpdateExternalReferencesToLatestDocumentsBody() # DocumentsUpdateExternalReferencesToLatestDocumentsBody | The JSON request body. (optional)

try:
    # Update External References to Latest
    api_response = api_instance.documents_update_external_references_to_latest_documents(did, wid, eid, body=body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->documents_update_external_references_to_latest_documents: %s\n" % e)
```

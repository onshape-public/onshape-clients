...
class BlobElementsUploadFileUpdateElementBody(object):
    ...
    def __init__(self, import_in_background=None, file_content_length=None, encoded_filename=None, flatten_assemblies=None, y_axis_is_up=None, translate=None, allow_faulty_parts=None):  # noqa: E501
        """BlobElementsUploadFileUpdateElementBody - a model defined in Swagger"""  # noqa: E501
    ...
    def import_in_background(self):
        """Gets the import_in_background of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        ...
        :return: The import_in_background of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def import_in_background(self, import_in_background):
        """Sets the import_in_background of this BlobElementsUploadFileUpdateElementBody.

        If storeInDocument is true and formatName is ONSHAPE and        the source is a Parasolid file, this specifies the preference as to whether the import should be completed        prior to the completion of the request (importInBackground=false) or whether it should be performed        asynchronously (importInBackground=true). Historically, this parameter was implicitly set to false, but large        imports can take long enough that the request could result in a timeout. Applications are encouraged to set        this parameter to true for reliable operation.  # noqa: E501

        :param import_in_background: The import_in_background of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        :type: bool
        """
    ...
    def file_content_length(self):
        """Gets the file_content_length of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        ...
        :return: The file_content_length of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        :rtype: float
        """
    ...
    def file_content_length(self, file_content_length):
        """Sets the file_content_length of this BlobElementsUploadFileUpdateElementBody.

        The length of the file being uploaded, in bytes. If not present,    Onshape may restrict the upload size under some operating conditions, as the file contents may need to be    buffered in memory. If specified, it should be the actual length of the data being uploaded.  # noqa: E501

        :param file_content_length: The file_content_length of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        :type: float
        """
    ...
    def encoded_filename(self):
        """Gets the encoded_filename of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        ...
        :return: The encoded_filename of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        :rtype: str
        """
    ...
    def encoded_filename(self, encoded_filename):
        """Sets the encoded_filename of this BlobElementsUploadFileUpdateElementBody.

        Filename override interpreted as a URL-encoded string. If specified,    this overrides the filename from a Content-Disposition in the file field.  # noqa: E501

        :param encoded_filename: The encoded_filename of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        :type: str
        """
    ...
    def flatten_assemblies(self):
        """Gets the flatten_assemblies of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501

        If true, remove assembly structure and create only a        Part Studio  # noqa: E501

        :return: The flatten_assemblies of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def flatten_assemblies(self, flatten_assemblies):
        """Sets the flatten_assemblies of this BlobElementsUploadFileUpdateElementBody.

        If true, remove assembly structure and create only a        Part Studio  # noqa: E501

        :param flatten_assemblies: The flatten_assemblies of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        :type: bool
        """
    ...
    def y_axis_is_up(self):
        """Gets the y_axis_is_up of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501

        If true, treat the model's Y axis as the vertical axis.  Otherwise,        Z is treated as the vertical axis.  # noqa: E501

        :return: The y_axis_is_up of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def y_axis_is_up(self, y_axis_is_up):
        """Sets the y_axis_is_up of this BlobElementsUploadFileUpdateElementBody.

        If true, treat the model's Y axis as the vertical axis.  Otherwise,        Z is treated as the vertical axis.  # noqa: E501

        :param y_axis_is_up: The y_axis_is_up of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def translate(self):
        """Gets the translate of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501

        Whether the uploaded file should be translated to Onshape format,    if possible  # noqa: E501

        :return: The translate of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def translate(self, translate):
        """Sets the translate of this BlobElementsUploadFileUpdateElementBody.

        Whether the uploaded file should be translated to Onshape format,    if possible  # noqa: E501

        :param translate: The translate of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        :type: bool
        """
    ...
    def allow_faulty_parts(self):
        """Gets the allow_faulty_parts of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        ...
        :return: The allow_faulty_parts of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_faulty_parts(self, allow_faulty_parts):
        """Sets the allow_faulty_parts of this BlobElementsUploadFileUpdateElementBody.

        If not specified or if specified as false, bodies to be imported        are examined for validity and any found to be faulty are removed from the import. If all bodies are found to        be faulty, the import fails. If the value is specified as true, we attempt to import the bodies that appear to        have faults.  # noqa: E501

        :param allow_faulty_parts: The allow_faulty_parts of this BlobElementsUploadFileUpdateElementBody.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BlobElementsUploadFileUpdateElementBody):
            return False

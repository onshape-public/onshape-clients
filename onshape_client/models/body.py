...
from onshape_client.models.body_principal_axes import BodyPrincipalAxes  # noqa: F401,E501
...
class Body(object):
    ...
    swagger_types = {
        ...
        'mass': 'list[float]',
        'principal_axes': 'list[BodyPrincipalAxes]',
        'inertia': 'list[float]',
        'has_mass': 'bool'
    }
    ...
    def mass_missing_count(self):
        """Gets the mass_missing_count of this Body.  # noqa: E501

        Number of parts without mass  # noqa: E501

        :return: The mass_missing_count of this Body.  # noqa: E501
        :rtype: float
        """
    ...
    def mass_missing_count(self, mass_missing_count):
        """Sets the mass_missing_count of this Body.

        Number of parts without mass  # noqa: E501

        :param mass_missing_count: The mass_missing_count of this Body.  # noqa: E501
        :type: float
        """
    ...
    @property
    def volume(self):
        """Gets the volume of this Body.  # noqa: E501

        Volume in cubic meters, along with minimum and maximum  # noqa: E501

        :return: The volume of this Body.  # noqa: E501
        :rtype: list[float]
        """
        return self._volume
    ...
    def volume(self, volume):
        """Sets the volume of this Body.

        Volume in cubic meters, along with minimum and maximum  # noqa: E501

        :param volume: The volume of this Body.  # noqa: E501
        :type: list[float]
        """
    ...
    @property
    def centroid(self):
        """Gets the centroid of this Body.  # noqa: E501
        ...
        :return: The centroid of this Body.  # noqa: E501
        :rtype: list[float]
        """
    ...
    def centroid(self, centroid):
        """Sets the centroid of this Body.

        Coordinates of the centroid (center of mass) in metric             units (3 numbers), along with minimum (3 numbers) and maximum (3 numbers)  # noqa: E501

        :param centroid: The centroid of this Body.  # noqa: E501
        :type: list[float]
        """
    ...
    @property
    def periphery(self):
        """Gets the periphery of this Body.  # noqa: E501
        ...
        :return: The periphery of this Body.  # noqa: E501
        :rtype: list[float]
        """
    ...
    def periphery(self, periphery):
        """Sets the periphery of this Body.

        Periphery in metric units which depend on context, along             with minimum and maximum; for a solid part, the periphery is the surface area in square meters; for a             surface, the periphery is the perimeter in meters  # noqa: E501

        :param periphery: The periphery of this Body.  # noqa: E501
        :type: list[float]
        """
    ...
    def principal_inertia(self):
        """Gets the principal_inertia of this Body.  # noqa: E501

        Moment of inertia around the principal axes in             metric units (3 numbers)  # noqa: E501

        :return: The principal_inertia of this Body.  # noqa: E501
        :rtype: list[float]
        """
    ...
    def principal_inertia(self, principal_inertia):
        """Sets the principal_inertia of this Body.

        Moment of inertia around the principal axes in             metric units (3 numbers)  # noqa: E501

        :param principal_inertia: The principal_inertia of this Body.  # noqa: E501
        :type: list[float]
        """
    ...
    @property
    def mass(self):
        """Gets the mass of this Body.  # noqa: E501

        Mass in kilograms, along with minimum and maximum  # noqa: E501

        :return: The mass of this Body.  # noqa: E501
        :rtype: list[float]
        """
        return self._mass
    ...
    def mass(self, mass):
        ...
        :param mass: The mass of this Body.  # noqa: E501
        :type: list[float]
        """
    ...
    def principal_axes(self):
        """Gets the principal_axes of this Body.  # noqa: E501

        Principal axes as unit vectors  # noqa: E501

        :return: The principal_axes of this Body.  # noqa: E501
        :rtype: list[BodyPrincipalAxes]
        """
        return self._principal_axes

    @principal_axes.setter
    def principal_axes(self, principal_axes):
        """Sets the principal_axes of this Body.

        Principal axes as unit vectors  # noqa: E501

        :param principal_axes: The principal_axes of this Body.  # noqa: E501
        :type: list[BodyPrincipalAxes]
        """
    ...
    @property
    def inertia(self):
        """Gets the inertia of this Body.  # noqa: E501
        ...
        :return: The inertia of this Body.  # noqa: E501
        :rtype: list[float]
        """
    ...
    def inertia(self, inertia):
        """Sets the inertia of this Body.

        Moment of inertia tensor about the centroid in metric units             with respect to the coordinate axes (9 numbers), along with minimum (9 numbers) and maximum (9             numbers)  # noqa: E501

        :param inertia: The inertia of this Body.  # noqa: E501
        :type: list[float]
        """
    ...
    @property
    def has_mass(self):
        """Gets the has_mass of this Body.  # noqa: E501

        Whether part has mass  # noqa: E501

        :return: The has_mass of this Body.  # noqa: E501
        :rtype: bool
        """
    ...
    def has_mass(self, has_mass):
        """Sets the has_mass of this Body.

        Whether part has mass  # noqa: E501

        :param has_mass: The has_mass of this Body.  # noqa: E501
        :type: bool
        """

...
// GetAllowPublicDocumentsAccess_ returns the AllowPublicDocumentsAccess_ field value if set, zero value otherwise.
...
// GetAllowPublicDocumentsAccess_Ok returns a tuple with the AllowPublicDocumentsAccess_ field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GlobalPermissionInfo) GetAllowPublicDocumentsAccess_Ok() (*bool, bool) {
	if o == nil || o.AllowPublicDocumentsAccess_ == nil {
		return nil, false
	}
...
// HasAllowPublicDocumentsAccess_ returns a boolean if a field has been set.
...
// SetAllowPublicDocumentsAccess_ gets a reference to the given bool and assigns it to the AllowPublicDocumentsAccess_ field.

...
BTListResponseBTMetadataPropertySummaryInfo::BTListResponseBTMetadataPropertySummaryInfo()
{
...
void BTListResponseBTMetadataPropertySummaryInfo::validate()
{
    // TODO: implement validation
}

web::json::value BTListResponseBTMetadataPropertySummaryInfo::toJson() const
{
...
bool BTListResponseBTMetadataPropertySummaryInfo::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t("items")))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<BTMetadataPropertySummaryInfo>> refVal_items;
...
void BTListResponseBTMetadataPropertySummaryInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTListResponseBTMetadataPropertySummaryInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t BTListResponseBTMetadataPropertySummaryInfo::getHref() const
{
    return m_Href;
}

void BTListResponseBTMetadataPropertySummaryInfo::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool BTListResponseBTMetadataPropertySummaryInfo::hrefIsSet() const
{
    return m_HrefIsSet;
}

void BTListResponseBTMetadataPropertySummaryInfo::unsetHref()
{
    m_HrefIsSet = false;
}
std::vector<std::shared_ptr<BTMetadataPropertySummaryInfo>>& BTListResponseBTMetadataPropertySummaryInfo::getItems()
{
    return m_Items;
}

void BTListResponseBTMetadataPropertySummaryInfo::setItems(const std::vector<std::shared_ptr<BTMetadataPropertySummaryInfo>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool BTListResponseBTMetadataPropertySummaryInfo::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void BTListResponseBTMetadataPropertySummaryInfo::unsetItems()
{
    m_ItemsIsSet = false;
}
utility::string_t BTListResponseBTMetadataPropertySummaryInfo::getNext() const
{
    return m_Next;
}

void BTListResponseBTMetadataPropertySummaryInfo::setNext(const utility::string_t& value)
{
    m_Next = value;
    m_NextIsSet = true;
}

bool BTListResponseBTMetadataPropertySummaryInfo::nextIsSet() const
{
    return m_NextIsSet;
}

void BTListResponseBTMetadataPropertySummaryInfo::unsetNext()
{
    m_NextIsSet = false;
}
utility::string_t BTListResponseBTMetadataPropertySummaryInfo::getPrevious() const
{
    return m_Previous;
}

void BTListResponseBTMetadataPropertySummaryInfo::setPrevious(const utility::string_t& value)
{
    m_Previous = value;
    m_PreviousIsSet = true;
}

bool BTListResponseBTMetadataPropertySummaryInfo::previousIsSet() const
{
    return m_PreviousIsSet;
}

void BTListResponseBTMetadataPropertySummaryInfo::unsetPrevious()
{
    m_PreviousIsSet = false;
}
}

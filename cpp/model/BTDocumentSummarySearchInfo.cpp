...
#include "BTDocumentSummarySearchInfo.h"
...
void BTDocumentSummarySearchInfo::validate()
{
    // TODO: implement validation
}

web::json::value BTDocumentSummarySearchInfo::toJson() const
{
    web::json::value val = this->BTDocumentSummaryInfo::toJson();
...
bool BTDocumentSummarySearchInfo::fromJson(const web::json::value& val)
{
    bool ok = true;
    ok &= this->BTDocumentSummaryInfo::fromJson(val);
...
void BTDocumentSummarySearchInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTDocumentSummarySearchInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::vector<std::shared_ptr<BTDocumentSearchHitInfo>>& BTDocumentSummarySearchInfo::getSearchHits()
{
    return m_SearchHits;
}

void BTDocumentSummarySearchInfo::setSearchHits(const std::vector<std::shared_ptr<BTDocumentSearchHitInfo>>& value)
{
    m_SearchHits = value;
    m_SearchHitsIsSet = true;
}

bool BTDocumentSummarySearchInfo::searchHitsIsSet() const
{
    return m_SearchHitsIsSet;
}

void BTDocumentSummarySearchInfo::unsetSearchHits()
{
    m_SearchHitsIsSet = false;
}
}

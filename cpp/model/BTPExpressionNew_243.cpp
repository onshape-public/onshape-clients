...
#include "BTPExpressionNew_243.h"
...
BTPExpressionNew_243::BTPExpressionNew_243()
{
...
void BTPExpressionNew_243::validate()
{
    // TODO: implement validation
}

web::json::value BTPExpressionNew_243::toJson() const
{
...
bool BTPExpressionNew_243::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPExpressionNew_243::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPExpressionNew_243::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<BTPSpace_10> BTPExpressionNew_243::getSpaceBetweenNewBox() const
{
    return m_SpaceBetweenNewBox;
}

void BTPExpressionNew_243::setSpaceBetweenNewBox(const std::shared_ptr<BTPSpace_10>& value)
{
    m_SpaceBetweenNewBox = value;
    m_SpaceBetweenNewBoxIsSet = true;
}

bool BTPExpressionNew_243::spaceBetweenNewBoxIsSet() const
{
    return m_SpaceBetweenNewBoxIsSet;
}

void BTPExpressionNew_243::unsetSpaceBetweenNewBox()
{
    m_SpaceBetweenNewBoxIsSet = false;
}
std::shared_ptr<BTPSpace_10> BTPExpressionNew_243::getSpaceAfterBox() const
{
    return m_SpaceAfterBox;
}

void BTPExpressionNew_243::setSpaceAfterBox(const std::shared_ptr<BTPSpace_10>& value)
{
    m_SpaceAfterBox = value;
    m_SpaceAfterBoxIsSet = true;
}

bool BTPExpressionNew_243::spaceAfterBoxIsSet() const
{
    return m_SpaceAfterBoxIsSet;
}

void BTPExpressionNew_243::unsetSpaceAfterBox()
{
    m_SpaceAfterBoxIsSet = false;
}
std::shared_ptr<BTPExpression_9> BTPExpressionNew_243::getValue() const
{
    return m_Value;
}

void BTPExpressionNew_243::setValue(const std::shared_ptr<BTPExpression_9>& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool BTPExpressionNew_243::valueIsSet() const
{
    return m_ValueIsSet;
}

void BTPExpressionNew_243::unsetValue()
{
    m_ValueIsSet = false;
}
}

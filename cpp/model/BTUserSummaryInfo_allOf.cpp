...
#include "BTUserSummaryInfo_allOf.h"
...
BTUserSummaryInfo_allOf::BTUserSummaryInfo_allOf()
{
    m_Source = 0;
    m_SourceIsSet = false;
...
void BTUserSummaryInfo_allOf::validate()
{
    // TODO: implement validation
}

web::json::value BTUserSummaryInfo_allOf::toJson() const
{
...
bool BTUserSummaryInfo_allOf::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTUserSummaryInfo_allOf::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTUserSummaryInfo_allOf::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
int32_t BTUserSummaryInfo_allOf::getSource() const
{
    return m_Source;
}

void BTUserSummaryInfo_allOf::setSource(int32_t value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool BTUserSummaryInfo_allOf::sourceIsSet() const
{
    return m_SourceIsSet;
}

void BTUserSummaryInfo_allOf::unsetSource()
{
    m_SourceIsSet = false;
}
std::shared_ptr<BTCompanySummaryInfo> BTUserSummaryInfo_allOf::getCompany() const
{
    return m_Company;
}

void BTUserSummaryInfo_allOf::setCompany(const std::shared_ptr<BTCompanySummaryInfo>& value)
{
    m_Company = value;
    m_CompanyIsSet = true;
}

bool BTUserSummaryInfo_allOf::companyIsSet() const
{
    return m_CompanyIsSet;
}

void BTUserSummaryInfo_allOf::unsetCompany()
{
    m_CompanyIsSet = false;
}
std::shared_ptr<GlobalPermissionInfo> BTUserSummaryInfo_allOf::getGlobalPermissions() const
{
    return m_GlobalPermissions;
}

void BTUserSummaryInfo_allOf::setGlobalPermissions(const std::shared_ptr<GlobalPermissionInfo>& value)
{
    m_GlobalPermissions = value;
    m_GlobalPermissionsIsSet = true;
}

bool BTUserSummaryInfo_allOf::globalPermissionsIsSet() const
{
    return m_GlobalPermissionsIsSet;
}

void BTUserSummaryInfo_allOf::unsetGlobalPermissions()
{
    m_GlobalPermissionsIsSet = false;
}
bool BTUserSummaryInfo_allOf::isIsGuest() const
{
    return m_IsGuest;
}

void BTUserSummaryInfo_allOf::setIsGuest(bool value)
{
    m_IsGuest = value;
    m_IsGuestIsSet = true;
}

bool BTUserSummaryInfo_allOf::isGuestIsSet() const
{
    return m_IsGuestIsSet;
}

void BTUserSummaryInfo_allOf::unsetIsGuest()
{
    m_IsGuestIsSet = false;
}
bool BTUserSummaryInfo_allOf::isIsLight() const
{
    return m_IsLight;
}

void BTUserSummaryInfo_allOf::setIsLight(bool value)
{
    m_IsLight = value;
    m_IsLightIsSet = true;
}

bool BTUserSummaryInfo_allOf::isLightIsSet() const
{
    return m_IsLightIsSet;
}

void BTUserSummaryInfo_allOf::unsetIsLight()
{
    m_IsLightIsSet = false;
}
utility::datetime BTUserSummaryInfo_allOf::getLastLoginTime() const
{
    return m_LastLoginTime;
}

void BTUserSummaryInfo_allOf::setLastLoginTime(const utility::datetime& value)
{
    m_LastLoginTime = value;
    m_LastLoginTimeIsSet = true;
}

bool BTUserSummaryInfo_allOf::lastLoginTimeIsSet() const
{
    return m_LastLoginTimeIsSet;
}

void BTUserSummaryInfo_allOf::unsetLastLoginTime()
{
    m_LastLoginTimeIsSet = false;
}
utility::string_t BTUserSummaryInfo_allOf::getFirstName() const
{
    return m_FirstName;
}

void BTUserSummaryInfo_allOf::setFirstName(const utility::string_t& value)
{
    m_FirstName = value;
    m_FirstNameIsSet = true;
}

bool BTUserSummaryInfo_allOf::firstNameIsSet() const
{
    return m_FirstNameIsSet;
}

void BTUserSummaryInfo_allOf::unsetFirstName()
{
    m_FirstNameIsSet = false;
}
utility::string_t BTUserSummaryInfo_allOf::getLastName() const
{
    return m_LastName;
}

void BTUserSummaryInfo_allOf::setLastName(const utility::string_t& value)
{
    m_LastName = value;
    m_LastNameIsSet = true;
}

bool BTUserSummaryInfo_allOf::lastNameIsSet() const
{
    return m_LastNameIsSet;
}

void BTUserSummaryInfo_allOf::unsetLastName()
{
    m_LastNameIsSet = false;
}
utility::string_t BTUserSummaryInfo_allOf::getEmail() const
{
    return m_Email;
}

void BTUserSummaryInfo_allOf::setEmail(const utility::string_t& value)
{
    m_Email = value;
    m_EmailIsSet = true;
}

bool BTUserSummaryInfo_allOf::emailIsSet() const
{
    return m_EmailIsSet;
}

void BTUserSummaryInfo_allOf::unsetEmail()
{
    m_EmailIsSet = false;
}
}

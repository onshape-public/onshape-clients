...
BTAndFilter_110::BTAndFilter_110()
{
...
void BTAndFilter_110::validate()
{
    // TODO: implement validation
}

web::json::value BTAndFilter_110::toJson() const
{
...
bool BTAndFilter_110::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTAndFilter_110::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTAndFilter_110::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<BTQueryFilter_183> BTAndFilter_110::getOperand1() const
{
    return m_Operand1;
}

void BTAndFilter_110::setOperand1(const std::shared_ptr<BTQueryFilter_183>& value)
{
    m_Operand1 = value;
    m_Operand1IsSet = true;
}

bool BTAndFilter_110::operand1IsSet() const
{
    return m_Operand1IsSet;
}

void BTAndFilter_110::unsetOperand1()
{
    m_Operand1IsSet = false;
}
std::shared_ptr<BTQueryFilter_183> BTAndFilter_110::getOperand2() const
{
    return m_Operand2;
}

void BTAndFilter_110::setOperand2(const std::shared_ptr<BTQueryFilter_183>& value)
{
    m_Operand2 = value;
    m_Operand2IsSet = true;
}

bool BTAndFilter_110::operand2IsSet() const
{
    return m_Operand2IsSet;
}

void BTAndFilter_110::unsetOperand2()
{
    m_Operand2IsSet = false;
}
}

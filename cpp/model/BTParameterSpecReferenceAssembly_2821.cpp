...
#include "BTParameterSpecReferenceAssembly_2821.h"
...
BTParameterSpecReferenceAssembly_2821::BTParameterSpecReferenceAssembly_2821()
{
}
...
void BTParameterSpecReferenceAssembly_2821::validate()
{
    // TODO: implement validation
}

web::json::value BTParameterSpecReferenceAssembly_2821::toJson() const
{
...
bool BTParameterSpecReferenceAssembly_2821::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTParameterSpecReferenceAssembly_2821::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTParameterSpecReferenceAssembly_2821::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

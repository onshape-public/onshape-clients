...
/*
 * SubscriptionItemCollection.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SubscriptionItemCollection_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_SubscriptionItemCollection_H_
...
/// 
/// </summary>
class  SubscriptionItemCollection
    : public ModelBase
{
public:
    SubscriptionItemCollection();
    virtual ~SubscriptionItemCollection();
    ...
    /////////////////////////////////////////////
    /// SubscriptionItemCollection members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<SubscriptionItem>>& getData();
    bool dataIsSet() const;
    void unsetData();

    void setData(const std::vector<std::shared_ptr<SubscriptionItem>>& value);
...
protected:
    int32_t m_Count;
    bool m_CountIsSet;
    std::vector<std::shared_ptr<SubscriptionItem>> m_Data;
    bool m_DataIsSet;
    bool m_HasMore;
    bool m_HasMoreIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_SubscriptionItemCollection_H_ */

...
#include "BTParameterSpecReferenceTable_1520.h"
...
BTParameterSpecReferenceTable_1520::BTParameterSpecReferenceTable_1520()
{
}
...
void BTParameterSpecReferenceTable_1520::validate()
{
    // TODO: implement validation
}

web::json::value BTParameterSpecReferenceTable_1520::toJson() const
{
...
bool BTParameterSpecReferenceTable_1520::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTParameterSpecReferenceTable_1520::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTParameterSpecReferenceTable_1520::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

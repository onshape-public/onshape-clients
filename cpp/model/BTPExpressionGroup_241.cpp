...
#include "BTPExpressionGroup_241.h"
...
BTPExpressionGroup_241::BTPExpressionGroup_241()
{
...
void BTPExpressionGroup_241::validate()
{
    // TODO: implement validation
}

web::json::value BTPExpressionGroup_241::toJson() const
{
...
bool BTPExpressionGroup_241::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPExpressionGroup_241::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPExpressionGroup_241::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<BTPExpression_9> BTPExpressionGroup_241::getContent() const
{
    return m_Content;
}

void BTPExpressionGroup_241::setContent(const std::shared_ptr<BTPExpression_9>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool BTPExpressionGroup_241::contentIsSet() const
{
    return m_ContentIsSet;
}

void BTPExpressionGroup_241::unsetContent()
{
    m_ContentIsSet = false;
}
}

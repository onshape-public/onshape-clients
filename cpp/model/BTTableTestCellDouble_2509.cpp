...
#include "BTTableTestCellDouble_2509.h"
...
BTTableTestCellDouble_2509::BTTableTestCellDouble_2509()
{
    m_CellValue = 0.0;
...
void BTTableTestCellDouble_2509::validate()
{
    // TODO: implement validation
}

web::json::value BTTableTestCellDouble_2509::toJson() const
{
...
bool BTTableTestCellDouble_2509::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTTableTestCellDouble_2509::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTTableTestCellDouble_2509::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
double BTTableTestCellDouble_2509::getCellValue() const
{
    return m_CellValue;
}

void BTTableTestCellDouble_2509::setCellValue(double value)
{
    m_CellValue = value;
    m_CellValueIsSet = true;
}

bool BTTableTestCellDouble_2509::cellValueIsSet() const
{
    return m_CellValueIsSet;
}

void BTTableTestCellDouble_2509::unsetCellValue()
{
    m_CellValueIsSet = false;
}
}

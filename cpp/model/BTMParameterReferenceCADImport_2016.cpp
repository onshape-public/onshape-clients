...
#include "BTMParameterReferenceCADImport_2016.h"
...
BTMParameterReferenceCADImport_2016::BTMParameterReferenceCADImport_2016()
{
}
...
void BTMParameterReferenceCADImport_2016::validate()
{
    // TODO: implement validation
}

web::json::value BTMParameterReferenceCADImport_2016::toJson() const
{
...
bool BTMParameterReferenceCADImport_2016::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTMParameterReferenceCADImport_2016::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTMParameterReferenceCADImport_2016::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

...
#include "BTParameterSpecBoolean_170.h"
...
BTParameterSpecBoolean_170::BTParameterSpecBoolean_170()
{
}
...
void BTParameterSpecBoolean_170::validate()
{
    // TODO: implement validation
}

web::json::value BTParameterSpecBoolean_170::toJson() const
{
...
bool BTParameterSpecBoolean_170::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTParameterSpecBoolean_170::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTParameterSpecBoolean_170::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

...
#include "BTMParameterReferenceJSON_790.h"
...
BTMParameterReferenceJSON_790::BTMParameterReferenceJSON_790()
{
}
...
void BTMParameterReferenceJSON_790::validate()
{
    // TODO: implement validation
}

web::json::value BTMParameterReferenceJSON_790::toJson() const
{
...
bool BTMParameterReferenceJSON_790::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTMParameterReferenceJSON_790::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTMParameterReferenceJSON_790::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

...
#include "BTParameterSpecReferenceJSON_1816.h"
...
BTParameterSpecReferenceJSON_1816::BTParameterSpecReferenceJSON_1816()
{
}
...
void BTParameterSpecReferenceJSON_1816::validate()
{
    // TODO: implement validation
}

web::json::value BTParameterSpecReferenceJSON_1816::toJson() const
{
...
bool BTParameterSpecReferenceJSON_1816::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTParameterSpecReferenceJSON_1816::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTParameterSpecReferenceJSON_1816::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

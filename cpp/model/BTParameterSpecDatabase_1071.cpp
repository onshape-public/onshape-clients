...
#include "BTParameterSpecDatabase_1071.h"
...
BTParameterSpecDatabase_1071::BTParameterSpecDatabase_1071()
{
}
...
void BTParameterSpecDatabase_1071::validate()
{
    // TODO: implement validation
}

web::json::value BTParameterSpecDatabase_1071::toJson() const
{
...
bool BTParameterSpecDatabase_1071::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTParameterSpecDatabase_1071::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTParameterSpecDatabase_1071::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

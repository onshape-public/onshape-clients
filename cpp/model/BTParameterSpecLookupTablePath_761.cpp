...
#include "BTParameterSpecLookupTablePath_761.h"
...
BTParameterSpecLookupTablePath_761::BTParameterSpecLookupTablePath_761()
{
...
void BTParameterSpecLookupTablePath_761::validate()
{
    // TODO: implement validation
}

web::json::value BTParameterSpecLookupTablePath_761::toJson() const
{
...
bool BTParameterSpecLookupTablePath_761::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTParameterSpecLookupTablePath_761::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTParameterSpecLookupTablePath_761::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<BTParameterLookupTableListEntry_1916> BTParameterSpecLookupTablePath_761::getLookupTable() const
{
    return m_LookupTable;
}

void BTParameterSpecLookupTablePath_761::setLookupTable(const std::shared_ptr<BTParameterLookupTableListEntry_1916>& value)
{
    m_LookupTable = value;
    m_LookupTableIsSet = true;
}

bool BTParameterSpecLookupTablePath_761::lookupTableIsSet() const
{
    return m_LookupTableIsSet;
}

void BTParameterSpecLookupTablePath_761::unsetLookupTable()
{
    m_LookupTableIsSet = false;
}
}

...
#include "BTParameterSpecString_175.h"
...
BTParameterSpecString_175::BTParameterSpecString_175()
{
...
void BTParameterSpecString_175::validate()
{
    // TODO: implement validation
}

web::json::value BTParameterSpecString_175::toJson() const
{
...
bool BTParameterSpecString_175::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTParameterSpecString_175::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTParameterSpecString_175::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::vector<std::shared_ptr<BTStringFormatCondition_683>>& BTParameterSpecString_175::getFormatConditions()
{
    return m_FormatConditions;
}

void BTParameterSpecString_175::setFormatConditions(const std::vector<std::shared_ptr<BTStringFormatCondition_683>>& value)
{
    m_FormatConditions = value;
    m_FormatConditionsIsSet = true;
}

bool BTParameterSpecString_175::formatConditionsIsSet() const
{
    return m_FormatConditionsIsSet;
}

void BTParameterSpecString_175::unsetFormatConditions()
{
    m_FormatConditionsIsSet = false;
}
}

...
#include "BTMParameterString_149.h"
...
BTMParameterString_149::BTMParameterString_149()
{
...
void BTMParameterString_149::validate()
{
    // TODO: implement validation
}

web::json::value BTMParameterString_149::toJson() const
{
...
bool BTMParameterString_149::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTMParameterString_149::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTMParameterString_149::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t BTMParameterString_149::getValue() const
{
    return m_Value;
}

void BTMParameterString_149::setValue(const utility::string_t& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool BTMParameterString_149::valueIsSet() const
{
    return m_ValueIsSet;
}

void BTMParameterString_149::unsetValue()
{
    m_ValueIsSet = false;
}
}

...
#include "BTParameterSpecReferencePartStudio_1256.h"
...
BTParameterSpecReferencePartStudio_1256::BTParameterSpecReferencePartStudio_1256()
{
...
void BTParameterSpecReferencePartStudio_1256::validate()
{
    // TODO: implement validation
}

web::json::value BTParameterSpecReferencePartStudio_1256::toJson() const
{
...
bool BTParameterSpecReferencePartStudio_1256::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTParameterSpecReferencePartStudio_1256::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTParameterSpecReferencePartStudio_1256::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
int32_t BTParameterSpecReferencePartStudio_1256::getMaxNumberOfPicks() const
{
    return m_MaxNumberOfPicks;
}

void BTParameterSpecReferencePartStudio_1256::setMaxNumberOfPicks(int32_t value)
{
    m_MaxNumberOfPicks = value;
    m_MaxNumberOfPicksIsSet = true;
}

bool BTParameterSpecReferencePartStudio_1256::maxNumberOfPicksIsSet() const
{
    return m_MaxNumberOfPicksIsSet;
}

void BTParameterSpecReferencePartStudio_1256::unsetMaxNumberOfPicks()
{
    m_MaxNumberOfPicksIsSet = false;
}
std::vector<utility::string_t>& BTParameterSpecReferencePartStudio_1256::getAllowedInsertableTypes()
{
    return m_AllowedInsertableTypes;
}

void BTParameterSpecReferencePartStudio_1256::setAllowedInsertableTypes(const std::vector<utility::string_t>& value)
{
    m_AllowedInsertableTypes = value;
    m_AllowedInsertableTypesIsSet = true;
}

bool BTParameterSpecReferencePartStudio_1256::allowedInsertableTypesIsSet() const
{
    return m_AllowedInsertableTypesIsSet;
}

void BTParameterSpecReferencePartStudio_1256::unsetAllowedInsertableTypes()
{
    m_AllowedInsertableTypesIsSet = false;
}
std::vector<std::shared_ptr<BTComputedConfigurationInputSpec_2525>>& BTParameterSpecReferencePartStudio_1256::getComputedConfigurationInputs()
{
    return m_ComputedConfigurationInputs;
}

void BTParameterSpecReferencePartStudio_1256::setComputedConfigurationInputs(const std::vector<std::shared_ptr<BTComputedConfigurationInputSpec_2525>>& value)
{
    m_ComputedConfigurationInputs = value;
    m_ComputedConfigurationInputsIsSet = true;
}

bool BTParameterSpecReferencePartStudio_1256::computedConfigurationInputsIsSet() const
{
    return m_ComputedConfigurationInputsIsSet;
}

void BTParameterSpecReferencePartStudio_1256::unsetComputedConfigurationInputs()
{
    m_ComputedConfigurationInputsIsSet = false;
}
}

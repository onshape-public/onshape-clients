...
/*
 * BTInheritedAclInfo.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_BTInheritedAclInfo_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_BTInheritedAclInfo_H_
...
public:
    ...
    /// 
    /// </summary>
    utility::string_t getObjectName() const;
    bool objectNameIsSet() const;
    void unsetObjectName();

    void setObjectName(const utility::string_t& value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_BTInheritedAclInfo_H_ */

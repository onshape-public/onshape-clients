...
#include "BTMAssemblyPatternFeature_2241.h"
...
BTMAssemblyPatternFeature_2241::BTMAssemblyPatternFeature_2241()
{
...
void BTMAssemblyPatternFeature_2241::validate()
{
    // TODO: implement validation
}

web::json::value BTMAssemblyPatternFeature_2241::toJson() const
{
...
bool BTMAssemblyPatternFeature_2241::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTMAssemblyPatternFeature_2241::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTMAssemblyPatternFeature_2241::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t BTMAssemblyPatternFeature_2241::getPatternType() const
{
    return m_PatternType;
}

void BTMAssemblyPatternFeature_2241::setPatternType(const utility::string_t& value)
{
    m_PatternType = value;
    m_PatternTypeIsSet = true;
}

bool BTMAssemblyPatternFeature_2241::patternTypeIsSet() const
{
    return m_PatternTypeIsSet;
}

void BTMAssemblyPatternFeature_2241::unsetPatternType()
{
    m_PatternTypeIsSet = false;
}
}

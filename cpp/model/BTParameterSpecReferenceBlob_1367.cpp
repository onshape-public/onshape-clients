...
BTParameterSpecReferenceBlob_1367::BTParameterSpecReferenceBlob_1367()
{
}
...
void BTParameterSpecReferenceBlob_1367::validate()
{
    // TODO: implement validation
}

web::json::value BTParameterSpecReferenceBlob_1367::toJson() const
{
...
bool BTParameterSpecReferenceBlob_1367::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTParameterSpecReferenceBlob_1367::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTParameterSpecReferenceBlob_1367::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

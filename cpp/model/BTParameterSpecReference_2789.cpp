...
BTParameterSpecReference_2789::BTParameterSpecReference_2789()
{
}
...
void BTParameterSpecReference_2789::validate()
{
    // TODO: implement validation
}

web::json::value BTParameterSpecReference_2789::toJson() const
{
...
bool BTParameterSpecReference_2789::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTParameterSpecReference_2789::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTParameterSpecReference_2789::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

...
#include "BTMAssemblyFeature1_2218.h"
...
BTMAssemblyFeature1_2218::BTMAssemblyFeature1_2218()
{
}
...
void BTMAssemblyFeature1_2218::validate()
{
    // TODO: implement validation
}

web::json::value BTMAssemblyFeature1_2218::toJson() const
{
...
bool BTMAssemblyFeature1_2218::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTMAssemblyFeature1_2218::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTMAssemblyFeature1_2218::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

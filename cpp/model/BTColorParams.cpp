...
void BTColorParams::validate()
{
    // TODO: implement validation
}

web::json::value BTColorParams::toJson() const
{
...
bool BTColorParams::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTColorParams::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTColorParams::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
int32_t BTColorParams::getBlue() const
{
    return m_Blue;
}

void BTColorParams::setBlue(int32_t value)
{
    m_Blue = value;
    m_BlueIsSet = true;
}

bool BTColorParams::blueIsSet() const
{
    return m_BlueIsSet;
}

void BTColorParams::unsetBlue()
{
    m_BlueIsSet = false;
}
int32_t BTColorParams::getGreen() const
{
    return m_Green;
}

void BTColorParams::setGreen(int32_t value)
{
    m_Green = value;
    m_GreenIsSet = true;
}

bool BTColorParams::greenIsSet() const
{
    return m_GreenIsSet;
}

void BTColorParams::unsetGreen()
{
    m_GreenIsSet = false;
}
int32_t BTColorParams::getRed() const
{
    return m_Red;
}

void BTColorParams::setRed(int32_t value)
{
    m_Red = value;
    m_RedIsSet = true;
}

bool BTColorParams::redIsSet() const
{
    return m_RedIsSet;
}

void BTColorParams::unsetRed()
{
    m_RedIsSet = false;
}
}

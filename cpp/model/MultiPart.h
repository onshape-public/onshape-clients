...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_MultiPart_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_MultiPart_H_
...
public:
    ...
    void setBodyParts(const std::vector<std::shared_ptr<BodyPart>>& value);
...
protected:
    std::vector<std::shared_ptr<BodyPart>> m_BodyParts;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_MultiPart_H_ */

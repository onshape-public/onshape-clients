...
#include "BTParameterSpecReferenceCADImport_1792.h"
...
BTParameterSpecReferenceCADImport_1792::BTParameterSpecReferenceCADImport_1792()
{
}
...
void BTParameterSpecReferenceCADImport_1792::validate()
{
    // TODO: implement validation
}

web::json::value BTParameterSpecReferenceCADImport_1792::toJson() const
{
...
bool BTParameterSpecReferenceCADImport_1792::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTParameterSpecReferenceCADImport_1792::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTParameterSpecReferenceCADImport_1792::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

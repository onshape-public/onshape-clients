...
BTPLiteralString_259::BTPLiteralString_259()
{
    m_Atomic = false;
    m_AtomicIsSet = false;
...
void BTPLiteralString_259::validate()
{
    // TODO: implement validation
}

web::json::value BTPLiteralString_259::toJson() const
{
...
bool BTPLiteralString_259::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPLiteralString_259::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPLiteralString_259::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
bool BTPLiteralString_259::isAtomic() const
{
    return m_Atomic;
}

void BTPLiteralString_259::setAtomic(bool value)
{
    m_Atomic = value;
    m_AtomicIsSet = true;
}

bool BTPLiteralString_259::atomicIsSet() const
{
    return m_AtomicIsSet;
}

void BTPLiteralString_259::unsetAtomic()
{
    m_AtomicIsSet = false;
}
utility::string_t BTPLiteralString_259::getBtType() const
{
    return m_BtType;
}

void BTPLiteralString_259::setBtType(const utility::string_t& value)
{
    m_BtType = value;
    m_BtTypeIsSet = true;
}

bool BTPLiteralString_259::btTypeIsSet() const
{
    return m_BtTypeIsSet;
}

void BTPLiteralString_259::unsetBtType()
{
    m_BtTypeIsSet = false;
}
utility::string_t BTPLiteralString_259::getDocumentationType() const
{
    return m_DocumentationType;
}

void BTPLiteralString_259::setDocumentationType(const utility::string_t& value)
{
    m_DocumentationType = value;
    m_DocumentationTypeIsSet = true;
}

bool BTPLiteralString_259::documentationTypeIsSet() const
{
    return m_DocumentationTypeIsSet;
}

void BTPLiteralString_259::unsetDocumentationType()
{
    m_DocumentationTypeIsSet = false;
}
int32_t BTPLiteralString_259::getEndSourceLocation() const
{
    return m_EndSourceLocation;
}

void BTPLiteralString_259::setEndSourceLocation(int32_t value)
{
    m_EndSourceLocation = value;
    m_EndSourceLocationIsSet = true;
}

bool BTPLiteralString_259::endSourceLocationIsSet() const
{
    return m_EndSourceLocationIsSet;
}

void BTPLiteralString_259::unsetEndSourceLocation()
{
    m_EndSourceLocationIsSet = false;
}
utility::string_t BTPLiteralString_259::getNodeId() const
{
    return m_NodeId;
}

void BTPLiteralString_259::setNodeId(const utility::string_t& value)
{
    m_NodeId = value;
    m_NodeIdIsSet = true;
}

bool BTPLiteralString_259::nodeIdIsSet() const
{
    return m_NodeIdIsSet;
}

void BTPLiteralString_259::unsetNodeId()
{
    m_NodeIdIsSet = false;
}
utility::string_t BTPLiteralString_259::getShortDescriptor() const
{
    return m_ShortDescriptor;
}

void BTPLiteralString_259::setShortDescriptor(const utility::string_t& value)
{
    m_ShortDescriptor = value;
    m_ShortDescriptorIsSet = true;
}

bool BTPLiteralString_259::shortDescriptorIsSet() const
{
    return m_ShortDescriptorIsSet;
}

void BTPLiteralString_259::unsetShortDescriptor()
{
    m_ShortDescriptorIsSet = false;
}
std::shared_ptr<BTPSpace_10> BTPLiteralString_259::getSpaceAfter() const
{
    return m_SpaceAfter;
}

void BTPLiteralString_259::setSpaceAfter(const std::shared_ptr<BTPSpace_10>& value)
{
    m_SpaceAfter = value;
    m_SpaceAfterIsSet = true;
}

bool BTPLiteralString_259::spaceAfterIsSet() const
{
    return m_SpaceAfterIsSet;
}

void BTPLiteralString_259::unsetSpaceAfter()
{
    m_SpaceAfterIsSet = false;
}
std::shared_ptr<BTPSpace_10> BTPLiteralString_259::getSpaceBefore() const
{
    return m_SpaceBefore;
}

void BTPLiteralString_259::setSpaceBefore(const std::shared_ptr<BTPSpace_10>& value)
{
    m_SpaceBefore = value;
    m_SpaceBeforeIsSet = true;
}

bool BTPLiteralString_259::spaceBeforeIsSet() const
{
    return m_SpaceBeforeIsSet;
}

void BTPLiteralString_259::unsetSpaceBefore()
{
    m_SpaceBeforeIsSet = false;
}
bool BTPLiteralString_259::isSpaceDefault() const
{
    return m_SpaceDefault;
}

void BTPLiteralString_259::setSpaceDefault(bool value)
{
    m_SpaceDefault = value;
    m_SpaceDefaultIsSet = true;
}

bool BTPLiteralString_259::spaceDefaultIsSet() const
{
    return m_SpaceDefaultIsSet;
}

void BTPLiteralString_259::unsetSpaceDefault()
{
    m_SpaceDefaultIsSet = false;
}
int32_t BTPLiteralString_259::getStartSourceLocation() const
{
    return m_StartSourceLocation;
}

void BTPLiteralString_259::setStartSourceLocation(int32_t value)
{
    m_StartSourceLocation = value;
    m_StartSourceLocationIsSet = true;
}

bool BTPLiteralString_259::startSourceLocationIsSet() const
{
    return m_StartSourceLocationIsSet;
}

void BTPLiteralString_259::unsetStartSourceLocation()
{
    m_StartSourceLocationIsSet = false;
}
utility::string_t BTPLiteralString_259::getText() const
{
    return m_Text;
}

void BTPLiteralString_259::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}

bool BTPLiteralString_259::textIsSet() const
{
    return m_TextIsSet;
}

void BTPLiteralString_259::unsetText()
{
    m_TextIsSet = false;
}
utility::string_t BTPLiteralString_259::getValue() const
{
    return m_Value;
}

void BTPLiteralString_259::setValue(const utility::string_t& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool BTPLiteralString_259::valueIsSet() const
{
    return m_ValueIsSet;
}

void BTPLiteralString_259::unsetValue()
{
    m_ValueIsSet = false;
}
}

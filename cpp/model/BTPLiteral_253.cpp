...
void BTPLiteral_253::validate()
{
    // TODO: implement validation
}

web::json::value BTPLiteral_253::toJson() const
{
...
bool BTPLiteral_253::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPLiteral_253::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPLiteral_253::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

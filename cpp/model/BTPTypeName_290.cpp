...
BTPTypeName_290::BTPTypeName_290()
{
}
...
void BTPTypeName_290::validate()
{
    // TODO: implement validation
}

web::json::value BTPTypeName_290::toJson() const
{
...
bool BTPTypeName_290::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPTypeName_290::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPTypeName_290::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

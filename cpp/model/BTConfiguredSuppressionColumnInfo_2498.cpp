...
#include "BTConfiguredSuppressionColumnInfo_2498.h"
...
BTConfiguredSuppressionColumnInfo_2498::BTConfiguredSuppressionColumnInfo_2498()
{
}
...
void BTConfiguredSuppressionColumnInfo_2498::validate()
{
    // TODO: implement validation
}

web::json::value BTConfiguredSuppressionColumnInfo_2498::toJson() const
{
...
bool BTConfiguredSuppressionColumnInfo_2498::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTConfiguredSuppressionColumnInfo_2498::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTConfiguredSuppressionColumnInfo_2498::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_FormDataBodyPart_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_FormDataBodyPart_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<FormDataContentDisposition> getFormDataContentDisposition() const;
    bool formDataContentDispositionIsSet() const;
    void unsetFormDataContentDisposition();

    void setFormDataContentDisposition(const std::shared_ptr<FormDataContentDisposition>& value);
...
protected:
    ...
    bool m_EntityIsSet;
    std::shared_ptr<FormDataContentDisposition> m_FormDataContentDisposition;
    bool m_FormDataContentDispositionIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_FormDataBodyPart_H_ */

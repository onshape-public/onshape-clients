...
#include "BTPLiteralUndefined_260.h"
...
BTPLiteralUndefined_260::BTPLiteralUndefined_260()
{
}
...
void BTPLiteralUndefined_260::validate()
{
    // TODO: implement validation
}

web::json::value BTPLiteralUndefined_260::toJson() const
{
...
bool BTPLiteralUndefined_260::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPLiteralUndefined_260::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPLiteralUndefined_260::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

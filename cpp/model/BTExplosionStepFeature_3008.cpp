...
BTExplosionStepFeature_3008::BTExplosionStepFeature_3008()
{
}
...
void BTExplosionStepFeature_3008::validate()
{
    // TODO: implement validation
}

web::json::value BTExplosionStepFeature_3008::toJson() const
{
...
bool BTExplosionStepFeature_3008::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTExplosionStepFeature_3008::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTExplosionStepFeature_3008::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

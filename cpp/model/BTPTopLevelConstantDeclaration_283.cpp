...
#include "BTPTopLevelConstantDeclaration_283.h"
...
BTPTopLevelConstantDeclaration_283::BTPTopLevelConstantDeclaration_283()
{
...
void BTPTopLevelConstantDeclaration_283::validate()
{
    // TODO: implement validation
}

web::json::value BTPTopLevelConstantDeclaration_283::toJson() const
{
...
bool BTPTopLevelConstantDeclaration_283::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPTopLevelConstantDeclaration_283::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPTopLevelConstantDeclaration_283::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<BTPStatementConstantDeclaration_273> BTPTopLevelConstantDeclaration_283::getDeclaration() const
{
    return m_Declaration;
}

void BTPTopLevelConstantDeclaration_283::setDeclaration(const std::shared_ptr<BTPStatementConstantDeclaration_273>& value)
{
    m_Declaration = value;
    m_DeclarationIsSet = true;
}

bool BTPTopLevelConstantDeclaration_283::declarationIsSet() const
{
    return m_DeclarationIsSet;
}

void BTPTopLevelConstantDeclaration_283::unsetDeclaration()
{
    m_DeclarationIsSet = false;
}
}

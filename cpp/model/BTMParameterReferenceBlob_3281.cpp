...
BTMParameterReferenceBlob_3281::BTMParameterReferenceBlob_3281()
{
}
...
void BTMParameterReferenceBlob_3281::validate()
{
    // TODO: implement validation
}

web::json::value BTMParameterReferenceBlob_3281::toJson() const
{
...
bool BTMParameterReferenceBlob_3281::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTMParameterReferenceBlob_3281::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTMParameterReferenceBlob_3281::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

...
/*
 * ExternalAccountCollection.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ExternalAccountCollection_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ExternalAccountCollection_H_
...
public:
    ...
    virtual ~ExternalAccountCollection();
    ...
    /////////////////////////////////////////////
    /// ExternalAccountCollection members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ExternalAccount>>& getData();
    bool dataIsSet() const;
    void unsetData();

    void setData(const std::vector<std::shared_ptr<ExternalAccount>>& value);
...
protected:
    int32_t m_Count;
    bool m_CountIsSet;
    std::vector<std::shared_ptr<ExternalAccount>> m_Data;
    bool m_DataIsSet;
    bool m_HasMore;
    bool m_HasMoreIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ExternalAccountCollection_H_ */

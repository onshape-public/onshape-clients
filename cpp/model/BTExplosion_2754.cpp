...
BTExplosion_2754::BTExplosion_2754()
{
...
void BTExplosion_2754::validate()
{
    // TODO: implement validation
}

web::json::value BTExplosion_2754::toJson() const
{
...
bool BTExplosion_2754::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTExplosion_2754::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTExplosion_2754::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::vector<std::shared_ptr<BTExplosionStepFeature_3008>>& BTExplosion_2754::getExplodeSteps()
{
    return m_ExplodeSteps;
}

void BTExplosion_2754::setExplodeSteps(const std::vector<std::shared_ptr<BTExplosionStepFeature_3008>>& value)
{
    m_ExplodeSteps = value;
    m_ExplodeStepsIsSet = true;
}

bool BTExplosion_2754::explodeStepsIsSet() const
{
    return m_ExplodeStepsIsSet;
}

void BTExplosion_2754::unsetExplodeSteps()
{
    m_ExplodeStepsIsSet = false;
}
std::shared_ptr<BTMicroversionIdAndConfiguration_2338> BTExplosion_2754::getStartingPositionId() const
{
    return m_StartingPositionId;
}

void BTExplosion_2754::setStartingPositionId(const std::shared_ptr<BTMicroversionIdAndConfiguration_2338>& value)
{
    m_StartingPositionId = value;
    m_StartingPositionIdIsSet = true;
}

bool BTExplosion_2754::startingPositionIdIsSet() const
{
    return m_StartingPositionIdIsSet;
}

void BTExplosion_2754::unsetStartingPositionId()
{
    m_StartingPositionIdIsSet = false;
}
}

...
#include "BTMParameterReferenceAssembly_938.h"
...
BTMParameterReferenceAssembly_938::BTMParameterReferenceAssembly_938()
{
}
...
void BTMParameterReferenceAssembly_938::validate()
{
    // TODO: implement validation
}

web::json::value BTMParameterReferenceAssembly_938::toJson() const
{
...
bool BTMParameterReferenceAssembly_938::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTMParameterReferenceAssembly_938::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTMParameterReferenceAssembly_938::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

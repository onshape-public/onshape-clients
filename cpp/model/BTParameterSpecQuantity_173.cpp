...
#include "BTParameterSpecQuantity_173.h"
...
BTParameterSpecQuantity_173::BTParameterSpecQuantity_173()
{
...
void BTParameterSpecQuantity_173::validate()
{
    // TODO: implement validation
}

web::json::value BTParameterSpecQuantity_173::toJson() const
{
...
bool BTParameterSpecQuantity_173::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTParameterSpecQuantity_173::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTParameterSpecQuantity_173::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t BTParameterSpecQuantity_173::getQuantityType() const
{
    return m_QuantityType;
}

void BTParameterSpecQuantity_173::setQuantityType(const utility::string_t& value)
{
    m_QuantityType = value;
    m_QuantityTypeIsSet = true;
}

bool BTParameterSpecQuantity_173::quantityTypeIsSet() const
{
    return m_QuantityTypeIsSet;
}

void BTParameterSpecQuantity_173::unsetQuantityType()
{
    m_QuantityTypeIsSet = false;
}
std::vector<std::shared_ptr<BTQuantityRange_181>>& BTParameterSpecQuantity_173::getRanges()
{
    return m_Ranges;
}

void BTParameterSpecQuantity_173::setRanges(const std::vector<std::shared_ptr<BTQuantityRange_181>>& value)
{
    m_Ranges = value;
    m_RangesIsSet = true;
}

bool BTParameterSpecQuantity_173::rangesIsSet() const
{
    return m_RangesIsSet;
}

void BTParameterSpecQuantity_173::unsetRanges()
{
    m_RangesIsSet = false;
}
}

...
void FormDataContentDisposition::validate()
{
    // TODO: implement validation
}

web::json::value FormDataContentDisposition::toJson() const
{
...
bool FormDataContentDisposition::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void FormDataContentDisposition::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FormDataContentDisposition::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::datetime FormDataContentDisposition::getCreationDate() const
{
    return m_CreationDate;
}

void FormDataContentDisposition::setCreationDate(const utility::datetime& value)
{
    m_CreationDate = value;
    m_CreationDateIsSet = true;
}

bool FormDataContentDisposition::creationDateIsSet() const
{
    return m_CreationDateIsSet;
}

void FormDataContentDisposition::unsetCreationDate()
{
    m_CreationDateIsSet = false;
}
utility::string_t FormDataContentDisposition::getFileName() const
{
    return m_FileName;
}

void FormDataContentDisposition::setFileName(const utility::string_t& value)
{
    m_FileName = value;
    m_FileNameIsSet = true;
}

bool FormDataContentDisposition::fileNameIsSet() const
{
    return m_FileNameIsSet;
}

void FormDataContentDisposition::unsetFileName()
{
    m_FileNameIsSet = false;
}
utility::datetime FormDataContentDisposition::getModificationDate() const
{
    return m_ModificationDate;
}

void FormDataContentDisposition::setModificationDate(const utility::datetime& value)
{
    m_ModificationDate = value;
    m_ModificationDateIsSet = true;
}

bool FormDataContentDisposition::modificationDateIsSet() const
{
    return m_ModificationDateIsSet;
}

void FormDataContentDisposition::unsetModificationDate()
{
    m_ModificationDateIsSet = false;
}
utility::string_t FormDataContentDisposition::getName() const
{
    return m_Name;
}

void FormDataContentDisposition::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool FormDataContentDisposition::nameIsSet() const
{
    return m_NameIsSet;
}

void FormDataContentDisposition::unsetName()
{
    m_NameIsSet = false;
}
std::map<utility::string_t, utility::string_t>& FormDataContentDisposition::getParameters()
{
    return m_Parameters;
}

void FormDataContentDisposition::setParameters(const std::map<utility::string_t, utility::string_t>& value)
{
    m_Parameters = value;
    m_ParametersIsSet = true;
}

bool FormDataContentDisposition::parametersIsSet() const
{
    return m_ParametersIsSet;
}

void FormDataContentDisposition::unsetParameters()
{
    m_ParametersIsSet = false;
}
utility::datetime FormDataContentDisposition::getReadDate() const
{
    return m_ReadDate;
}

void FormDataContentDisposition::setReadDate(const utility::datetime& value)
{
    m_ReadDate = value;
    m_ReadDateIsSet = true;
}

bool FormDataContentDisposition::readDateIsSet() const
{
    return m_ReadDateIsSet;
}

void FormDataContentDisposition::unsetReadDate()
{
    m_ReadDateIsSet = false;
}
int64_t FormDataContentDisposition::getSize() const
{
    return m_Size;
}

void FormDataContentDisposition::setSize(int64_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

bool FormDataContentDisposition::sizeIsSet() const
{
    return m_SizeIsSet;
}

void FormDataContentDisposition::unsetSize()
{
    m_SizeIsSet = false;
}
utility::string_t FormDataContentDisposition::getType() const
{
    return m_Type;
}

void FormDataContentDisposition::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool FormDataContentDisposition::typeIsSet() const
{
    return m_TypeIsSet;
}

void FormDataContentDisposition::unsetType()
{
    m_TypeIsSet = false;
}
}

...
#include "BTPPredicateDeclaration_265.h"
...
BTPPredicateDeclaration_265::BTPPredicateDeclaration_265()
{
}
...
void BTPPredicateDeclaration_265::validate()
{
    // TODO: implement validation
}

web::json::value BTPPredicateDeclaration_265::toJson() const
{
...
bool BTPPredicateDeclaration_265::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPPredicateDeclaration_265::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPPredicateDeclaration_265::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

...
/*
 * BTDocumentLabelInfo.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_BTDocumentLabelInfo_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_BTDocumentLabelInfo_H_
...
public:
    ...
    /// 
    /// </summary>
    utility::string_t getParentLabelId() const;
    bool parentLabelIdIsSet() const;
    void unsetParentLabelId();

    void setParentLabelId(const utility::string_t& value);
...
protected:
    ...
    bool m_OwnerIsSet;
    utility::string_t m_ParentLabelId;
    bool m_ParentLabelIdIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_BTDocumentLabelInfo_H_ */

...
#include "BTMIndividualSketchUniqueVerticesQuery_1472.h"
...
BTMIndividualSketchUniqueVerticesQuery_1472::BTMIndividualSketchUniqueVerticesQuery_1472()
{
...
void BTMIndividualSketchUniqueVerticesQuery_1472::validate()
{
    // TODO: implement validation
}

web::json::value BTMIndividualSketchUniqueVerticesQuery_1472::toJson() const
{
...
bool BTMIndividualSketchUniqueVerticesQuery_1472::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTMIndividualSketchUniqueVerticesQuery_1472::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTMIndividualSketchUniqueVerticesQuery_1472::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t BTMIndividualSketchUniqueVerticesQuery_1472::getFeatureId() const
{
    return m_FeatureId;
}

void BTMIndividualSketchUniqueVerticesQuery_1472::setFeatureId(const utility::string_t& value)
{
    m_FeatureId = value;
    m_FeatureIdIsSet = true;
}

bool BTMIndividualSketchUniqueVerticesQuery_1472::featureIdIsSet() const
{
    return m_FeatureIdIsSet;
}

void BTMIndividualSketchUniqueVerticesQuery_1472::unsetFeatureId()
{
    m_FeatureIdIsSet = false;
}
}

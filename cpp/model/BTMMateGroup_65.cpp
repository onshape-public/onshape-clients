...
BTMMateGroup_65::BTMMateGroup_65()
{
}
...
void BTMMateGroup_65::validate()
{
    // TODO: implement validation
}

web::json::value BTMMateGroup_65::toJson() const
{
...
bool BTMMateGroup_65::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTMMateGroup_65::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTMMateGroup_65::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

...
BTPStatementBlock_271::BTPStatementBlock_271()
{
...
void BTPStatementBlock_271::validate()
{
    // TODO: implement validation
}

web::json::value BTPStatementBlock_271::toJson() const
{
...
bool BTPStatementBlock_271::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPStatementBlock_271::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPStatementBlock_271::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<BTPSpace_10> BTPStatementBlock_271::getSpaceAfterOpen() const
{
    return m_SpaceAfterOpen;
}

void BTPStatementBlock_271::setSpaceAfterOpen(const std::shared_ptr<BTPSpace_10>& value)
{
    m_SpaceAfterOpen = value;
    m_SpaceAfterOpenIsSet = true;
}

bool BTPStatementBlock_271::spaceAfterOpenIsSet() const
{
    return m_SpaceAfterOpenIsSet;
}

void BTPStatementBlock_271::unsetSpaceAfterOpen()
{
    m_SpaceAfterOpenIsSet = false;
}
}

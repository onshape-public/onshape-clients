...
#include "BTMNonGeometricItem_1864.h"
...
BTMNonGeometricItem_1864::BTMNonGeometricItem_1864()
{
...
void BTMNonGeometricItem_1864::validate()
{
    // TODO: implement validation
}

web::json::value BTMNonGeometricItem_1864::toJson() const
{
...
bool BTMNonGeometricItem_1864::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTMNonGeometricItem_1864::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTMNonGeometricItem_1864::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t BTMNonGeometricItem_1864::getItemDefinitionId() const
{
    return m_ItemDefinitionId;
}

void BTMNonGeometricItem_1864::setItemDefinitionId(const utility::string_t& value)
{
    m_ItemDefinitionId = value;
    m_ItemDefinitionIdIsSet = true;
}

bool BTMNonGeometricItem_1864::itemDefinitionIdIsSet() const
{
    return m_ItemDefinitionIdIsSet;
}

void BTMNonGeometricItem_1864::unsetItemDefinitionId()
{
    m_ItemDefinitionIdIsSet = false;
}
}

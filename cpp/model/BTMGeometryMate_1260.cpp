...
#include "BTMGeometryMate_1260.h"
...
BTMGeometryMate_1260::BTMGeometryMate_1260()
{
}
...
void BTMGeometryMate_1260::validate()
{
    // TODO: implement validation
}

web::json::value BTMGeometryMate_1260::toJson() const
{
...
bool BTMGeometryMate_1260::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTMGeometryMate_1260::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTMGeometryMate_1260::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

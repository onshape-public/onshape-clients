...
#include "BTParameterSpecDerived_736.h"
...
BTParameterSpecDerived_736::BTParameterSpecDerived_736()
{
}
...
void BTParameterSpecDerived_736::validate()
{
    // TODO: implement validation
}

web::json::value BTParameterSpecDerived_736::toJson() const
{
...
bool BTParameterSpecDerived_736::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTParameterSpecDerived_736::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTParameterSpecDerived_736::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

...
BTPStatementConstantDeclaration_273::BTPStatementConstantDeclaration_273()
{
...
void BTPStatementConstantDeclaration_273::validate()
{
    // TODO: implement validation
}

web::json::value BTPStatementConstantDeclaration_273::toJson() const
{
...
bool BTPStatementConstantDeclaration_273::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPStatementConstantDeclaration_273::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPStatementConstantDeclaration_273::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t BTPStatementConstantDeclaration_273::getStandardType() const
{
    return m_StandardType;
}

void BTPStatementConstantDeclaration_273::setStandardType(const utility::string_t& value)
{
    m_StandardType = value;
    m_StandardTypeIsSet = true;
}

bool BTPStatementConstantDeclaration_273::standardTypeIsSet() const
{
    return m_StandardTypeIsSet;
}

void BTPStatementConstantDeclaration_273::unsetStandardType()
{
    m_StandardTypeIsSet = false;
}
utility::string_t BTPStatementConstantDeclaration_273::getRTypeName() const
{
    return m_r_typeName;
}

void BTPStatementConstantDeclaration_273::setRTypeName(const utility::string_t& value)
{
    m_r_typeName = value;
    m_r_typeNameIsSet = true;
}

bool BTPStatementConstantDeclaration_273::rTypeNameIsSet() const
{
    return m_r_typeNameIsSet;
}

void BTPStatementConstantDeclaration_273::unsetr_typeName()
{
    m_r_typeNameIsSet = false;
}
std::shared_ptr<BTPIdentifier_8> BTPStatementConstantDeclaration_273::getName() const
{
    return m_Name;
}

void BTPStatementConstantDeclaration_273::setName(const std::shared_ptr<BTPIdentifier_8>& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool BTPStatementConstantDeclaration_273::nameIsSet() const
{
    return m_NameIsSet;
}

void BTPStatementConstantDeclaration_273::unsetName()
{
    m_NameIsSet = false;
}
std::shared_ptr<BTPTypeName_290> BTPStatementConstantDeclaration_273::getType() const
{
    return m_Type;
}

void BTPStatementConstantDeclaration_273::setType(const std::shared_ptr<BTPTypeName_290>& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool BTPStatementConstantDeclaration_273::typeIsSet() const
{
    return m_TypeIsSet;
}

void BTPStatementConstantDeclaration_273::unsetType()
{
    m_TypeIsSet = false;
}
std::shared_ptr<BTPExpression_9> BTPStatementConstantDeclaration_273::getValue() const
{
    return m_Value;
}

void BTPStatementConstantDeclaration_273::setValue(const std::shared_ptr<BTPExpression_9>& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool BTPStatementConstantDeclaration_273::valueIsSet() const
{
    return m_ValueIsSet;
}

void BTPStatementConstantDeclaration_273::unsetValue()
{
    m_ValueIsSet = false;
}
}

...
void BTPLValue_249::validate()
{
    // TODO: implement validation
}

web::json::value BTPLValue_249::toJson() const
{
...
bool BTPLValue_249::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPLValue_249::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPLValue_249::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

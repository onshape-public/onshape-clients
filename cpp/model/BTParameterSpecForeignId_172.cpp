...
#include "BTParameterSpecForeignId_172.h"
...
BTParameterSpecForeignId_172::BTParameterSpecForeignId_172()
{
}
...
void BTParameterSpecForeignId_172::validate()
{
    // TODO: implement validation
}

web::json::value BTParameterSpecForeignId_172::toJson() const
{
...
bool BTParameterSpecForeignId_172::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTParameterSpecForeignId_172::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTParameterSpecForeignId_172::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

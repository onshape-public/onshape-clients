...
BTFeatureApiBase_1430::BTFeatureApiBase_1430()
{
...
void BTFeatureApiBase_1430::validate()
{
    // TODO: implement validation
}

web::json::value BTFeatureApiBase_1430::toJson() const
{
...
bool BTFeatureApiBase_1430::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTFeatureApiBase_1430::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTFeatureApiBase_1430::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t BTFeatureApiBase_1430::getBtType() const
{
    return m_BtType;
}

void BTFeatureApiBase_1430::setBtType(const utility::string_t& value)
{
    m_BtType = value;
    m_BtTypeIsSet = true;
}

bool BTFeatureApiBase_1430::btTypeIsSet() const
{
    return m_BtTypeIsSet;
}

void BTFeatureApiBase_1430::unsetBtType()
{
    m_BtTypeIsSet = false;
}
int32_t BTFeatureApiBase_1430::getLibraryVersion() const
{
    return m_LibraryVersion;
}

void BTFeatureApiBase_1430::setLibraryVersion(int32_t value)
{
    m_LibraryVersion = value;
    m_LibraryVersionIsSet = true;
}

bool BTFeatureApiBase_1430::libraryVersionIsSet() const
{
    return m_LibraryVersionIsSet;
}

void BTFeatureApiBase_1430::unsetLibraryVersion()
{
    m_LibraryVersionIsSet = false;
}
bool BTFeatureApiBase_1430::isMicroversionSkew() const
{
    return m_MicroversionSkew;
}

void BTFeatureApiBase_1430::setMicroversionSkew(bool value)
{
    m_MicroversionSkew = value;
    m_MicroversionSkewIsSet = true;
}

bool BTFeatureApiBase_1430::microversionSkewIsSet() const
{
    return m_MicroversionSkewIsSet;
}

void BTFeatureApiBase_1430::unsetMicroversionSkew()
{
    m_MicroversionSkewIsSet = false;
}
bool BTFeatureApiBase_1430::isRejectMicroversionSkew() const
{
    return m_RejectMicroversionSkew;
}

void BTFeatureApiBase_1430::setRejectMicroversionSkew(bool value)
{
    m_RejectMicroversionSkew = value;
    m_RejectMicroversionSkewIsSet = true;
}

bool BTFeatureApiBase_1430::rejectMicroversionSkewIsSet() const
{
    return m_RejectMicroversionSkewIsSet;
}

void BTFeatureApiBase_1430::unsetRejectMicroversionSkew()
{
    m_RejectMicroversionSkewIsSet = false;
}
utility::string_t BTFeatureApiBase_1430::getSerializationVersion() const
{
    return m_SerializationVersion;
}

void BTFeatureApiBase_1430::setSerializationVersion(const utility::string_t& value)
{
    m_SerializationVersion = value;
    m_SerializationVersionIsSet = true;
}

bool BTFeatureApiBase_1430::serializationVersionIsSet() const
{
    return m_SerializationVersionIsSet;
}

void BTFeatureApiBase_1430::unsetSerializationVersion()
{
    m_SerializationVersionIsSet = false;
}
utility::string_t BTFeatureApiBase_1430::getSourceMicroversion() const
{
    return m_SourceMicroversion;
}

void BTFeatureApiBase_1430::setSourceMicroversion(const utility::string_t& value)
{
    m_SourceMicroversion = value;
    m_SourceMicroversionIsSet = true;
}

bool BTFeatureApiBase_1430::sourceMicroversionIsSet() const
{
    return m_SourceMicroversionIsSet;
}

void BTFeatureApiBase_1430::unsetSourceMicroversion()
{
    m_SourceMicroversionIsSet = false;
}
}

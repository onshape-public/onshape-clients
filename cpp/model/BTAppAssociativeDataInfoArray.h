...
/*
 * BTAppAssociativeDataInfoArray.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_BTAppAssociativeDataInfoArray_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_BTAppAssociativeDataInfoArray_H_
...
/// 
/// </summary>
class  BTAppAssociativeDataInfoArray
    : public ModelBase
{
public:
    BTAppAssociativeDataInfoArray();
    virtual ~BTAppAssociativeDataInfoArray();
    ...
    /////////////////////////////////////////////
    /// BTAppAssociativeDataInfoArray members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<BTAssociativeDataInfo>>& getItems();
    bool itemsIsSet() const;
    void unsetItems();

    void setItems(const std::vector<std::shared_ptr<BTAssociativeDataInfo>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<BTAssociativeDataInfo>> m_Items;
    bool m_ItemsIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_BTAppAssociativeDataInfoArray_H_ */

...
#include "BTPStatementBreak_272.h"
...
BTPStatementBreak_272::BTPStatementBreak_272()
{
...
void BTPStatementBreak_272::validate()
{
    // TODO: implement validation
}

web::json::value BTPStatementBreak_272::toJson() const
{
...
bool BTPStatementBreak_272::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPStatementBreak_272::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPStatementBreak_272::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<BTPSpace_10> BTPStatementBreak_272::getSpaceAfterBreak() const
{
    return m_SpaceAfterBreak;
}

void BTPStatementBreak_272::setSpaceAfterBreak(const std::shared_ptr<BTPSpace_10>& value)
{
    m_SpaceAfterBreak = value;
    m_SpaceAfterBreakIsSet = true;
}

bool BTPStatementBreak_272::spaceAfterBreakIsSet() const
{
    return m_SpaceAfterBreakIsSet;
}

void BTPStatementBreak_272::unsetSpaceAfterBreak()
{
    m_SpaceAfterBreakIsSet = false;
}
}

...
CustomerCardCollection::CustomerCardCollection()
{
    m_Count = 0;
    m_CountIsSet = false;
    m_DataIsSet = false;
...
void CustomerCardCollection::validate()
{
    // TODO: implement validation
}

web::json::value CustomerCardCollection::toJson() const
{
...
bool CustomerCardCollection::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t("data")))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Card>> refVal_data;
...
void CustomerCardCollection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CustomerCardCollection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
int32_t CustomerCardCollection::getCount() const
{
    return m_Count;
}

void CustomerCardCollection::setCount(int32_t value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool CustomerCardCollection::countIsSet() const
{
    return m_CountIsSet;
}

void CustomerCardCollection::unsetCount()
{
    m_CountIsSet = false;
}
std::vector<std::shared_ptr<Card>>& CustomerCardCollection::getData()
{
    return m_Data;
}

void CustomerCardCollection::setData(const std::vector<std::shared_ptr<Card>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool CustomerCardCollection::dataIsSet() const
{
    return m_DataIsSet;
}

void CustomerCardCollection::unsetData()
{
    m_DataIsSet = false;
}
bool CustomerCardCollection::isHasMore() const
{
    return m_HasMore;
}

void CustomerCardCollection::setHasMore(bool value)
{
    m_HasMore = value;
    m_HasMoreIsSet = true;
}

bool CustomerCardCollection::hasMoreIsSet() const
{
    return m_HasMoreIsSet;
}

void CustomerCardCollection::unsetHasMore()
{
    m_HasMoreIsSet = false;
}
std::shared_ptr<RequestOptions> CustomerCardCollection::getRequestOptions() const
{
    return m_RequestOptions;
}

void CustomerCardCollection::setRequestOptions(const std::shared_ptr<RequestOptions>& value)
{
    m_RequestOptions = value;
    m_RequestOptionsIsSet = true;
}

bool CustomerCardCollection::requestOptionsIsSet() const
{
    return m_RequestOptionsIsSet;
}

void CustomerCardCollection::unsetRequestOptions()
{
    m_RequestOptionsIsSet = false;
}
std::map<utility::string_t, std::shared_ptr<Object>>& CustomerCardCollection::getRequestParams()
{
    return m_RequestParams;
}

void CustomerCardCollection::setRequestParams(const std::map<utility::string_t, std::shared_ptr<Object>>& value)
{
    m_RequestParams = value;
    m_RequestParamsIsSet = true;
}

bool CustomerCardCollection::requestParamsIsSet() const
{
    return m_RequestParamsIsSet;
}

void CustomerCardCollection::unsetRequestParams()
{
    m_RequestParamsIsSet = false;
}
int32_t CustomerCardCollection::getTotalCount() const
{
    return m_TotalCount;
}

void CustomerCardCollection::setTotalCount(int32_t value)
{
    m_TotalCount = value;
    m_TotalCountIsSet = true;
}

bool CustomerCardCollection::totalCountIsSet() const
{
    return m_TotalCountIsSet;
}

void CustomerCardCollection::unsetTotalCount()
{
    m_TotalCountIsSet = false;
}
utility::string_t CustomerCardCollection::getUrl() const
{
    return m_Url;
}

void CustomerCardCollection::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool CustomerCardCollection::urlIsSet() const
{
    return m_UrlIsSet;
}

void CustomerCardCollection::unsetUrl()
{
    m_UrlIsSet = false;
}
}

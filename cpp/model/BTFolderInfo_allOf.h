...
/*
 * BTFolderInfo_allOf.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_BTFolderInfo_allOf_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_BTFolderInfo_allOf_H_
...
/// 
/// </summary>
class  BTFolderInfo_allOf
    : public ModelBase
{
public:
    BTFolderInfo_allOf();
    virtual ~BTFolderInfo_allOf();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_BTFolderInfo_allOf_H_ */

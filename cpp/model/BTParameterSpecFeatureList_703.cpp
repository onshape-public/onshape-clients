...
#include "BTParameterSpecFeatureList_703.h"
...
BTParameterSpecFeatureList_703::BTParameterSpecFeatureList_703()
{
}
...
void BTParameterSpecFeatureList_703::validate()
{
    // TODO: implement validation
}

web::json::value BTParameterSpecFeatureList_703::toJson() const
{
...
bool BTParameterSpecFeatureList_703::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTParameterSpecFeatureList_703::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTParameterSpecFeatureList_703::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

...
BTPLiteralNumber_258::BTPLiteralNumber_258()
{
    m_Atomic = false;
    m_AtomicIsSet = false;
...
void BTPLiteralNumber_258::validate()
{
    // TODO: implement validation
}

web::json::value BTPLiteralNumber_258::toJson() const
{
    ...
    if(m_integerIsSet)
    {
        val[utility::conversions::to_string_t("integer")] = ModelBase::toJson(m_integer);
    }
    if(m_NodeIdIsSet)
    {
...
bool BTPLiteralNumber_258::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t("integer")))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("integer"));
        if(!fieldValue.is_null())
        {
            bool refVal_integer;
            ok &= ModelBase::fromJson(fieldValue, refVal_integer);
            setInteger(refVal_integer);
        }
    }
...
void BTPLiteralNumber_258::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_integerIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("integer"), m_integer));
    }
    if(m_NodeIdIsSet)
    {
...
bool BTPLiteralNumber_258::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("integer")))
    {
        bool refVal_integer;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t("integer")), refVal_integer );
        setInteger(refVal_integer);
    }
...
bool BTPLiteralNumber_258::isAtomic() const
{
    return m_Atomic;
}

void BTPLiteralNumber_258::setAtomic(bool value)
{
    m_Atomic = value;
    m_AtomicIsSet = true;
}

bool BTPLiteralNumber_258::atomicIsSet() const
{
    return m_AtomicIsSet;
}

void BTPLiteralNumber_258::unsetAtomic()
{
    m_AtomicIsSet = false;
}
utility::string_t BTPLiteralNumber_258::getBtType() const
{
    return m_BtType;
}

void BTPLiteralNumber_258::setBtType(const utility::string_t& value)
{
    m_BtType = value;
    m_BtTypeIsSet = true;
}

bool BTPLiteralNumber_258::btTypeIsSet() const
{
    return m_BtTypeIsSet;
}

void BTPLiteralNumber_258::unsetBtType()
{
    m_BtTypeIsSet = false;
}
utility::string_t BTPLiteralNumber_258::getDocumentationType() const
{
    return m_DocumentationType;
}

void BTPLiteralNumber_258::setDocumentationType(const utility::string_t& value)
{
    m_DocumentationType = value;
    m_DocumentationTypeIsSet = true;
}

bool BTPLiteralNumber_258::documentationTypeIsSet() const
{
    return m_DocumentationTypeIsSet;
}

void BTPLiteralNumber_258::unsetDocumentationType()
{
    m_DocumentationTypeIsSet = false;
}
int32_t BTPLiteralNumber_258::getEndSourceLocation() const
{
    return m_EndSourceLocation;
}

void BTPLiteralNumber_258::setEndSourceLocation(int32_t value)
{
    m_EndSourceLocation = value;
    m_EndSourceLocationIsSet = true;
}

bool BTPLiteralNumber_258::endSourceLocationIsSet() const
{
    return m_EndSourceLocationIsSet;
}

void BTPLiteralNumber_258::unsetEndSourceLocation()
{
    m_EndSourceLocationIsSet = false;
}
bool BTPLiteralNumber_258::isInteger() const
{
    return m_integer;
}

void BTPLiteralNumber_258::setInteger(bool value)
{
    m_integer = value;
    m_integerIsSet = true;
}

bool BTPLiteralNumber_258::integerIsSet() const
{
    return m_integerIsSet;
}

void BTPLiteralNumber_258::unsetinteger()
{
    m_integerIsSet = false;
}
utility::string_t BTPLiteralNumber_258::getNodeId() const
{
    return m_NodeId;
}

void BTPLiteralNumber_258::setNodeId(const utility::string_t& value)
{
    m_NodeId = value;
    m_NodeIdIsSet = true;
}

bool BTPLiteralNumber_258::nodeIdIsSet() const
{
    return m_NodeIdIsSet;
}

void BTPLiteralNumber_258::unsetNodeId()
{
    m_NodeIdIsSet = false;
}
utility::string_t BTPLiteralNumber_258::getShortDescriptor() const
{
    return m_ShortDescriptor;
}

void BTPLiteralNumber_258::setShortDescriptor(const utility::string_t& value)
{
    m_ShortDescriptor = value;
    m_ShortDescriptorIsSet = true;
}

bool BTPLiteralNumber_258::shortDescriptorIsSet() const
{
    return m_ShortDescriptorIsSet;
}

void BTPLiteralNumber_258::unsetShortDescriptor()
{
    m_ShortDescriptorIsSet = false;
}
std::shared_ptr<BTPSpace_10> BTPLiteralNumber_258::getSpaceAfter() const
{
    return m_SpaceAfter;
}

void BTPLiteralNumber_258::setSpaceAfter(const std::shared_ptr<BTPSpace_10>& value)
{
    m_SpaceAfter = value;
    m_SpaceAfterIsSet = true;
}

bool BTPLiteralNumber_258::spaceAfterIsSet() const
{
    return m_SpaceAfterIsSet;
}

void BTPLiteralNumber_258::unsetSpaceAfter()
{
    m_SpaceAfterIsSet = false;
}
std::shared_ptr<BTPSpace_10> BTPLiteralNumber_258::getSpaceBefore() const
{
    return m_SpaceBefore;
}

void BTPLiteralNumber_258::setSpaceBefore(const std::shared_ptr<BTPSpace_10>& value)
{
    m_SpaceBefore = value;
    m_SpaceBeforeIsSet = true;
}

bool BTPLiteralNumber_258::spaceBeforeIsSet() const
{
    return m_SpaceBeforeIsSet;
}

void BTPLiteralNumber_258::unsetSpaceBefore()
{
    m_SpaceBeforeIsSet = false;
}
bool BTPLiteralNumber_258::isSpaceDefault() const
{
    return m_SpaceDefault;
}

void BTPLiteralNumber_258::setSpaceDefault(bool value)
{
    m_SpaceDefault = value;
    m_SpaceDefaultIsSet = true;
}

bool BTPLiteralNumber_258::spaceDefaultIsSet() const
{
    return m_SpaceDefaultIsSet;
}

void BTPLiteralNumber_258::unsetSpaceDefault()
{
    m_SpaceDefaultIsSet = false;
}
int32_t BTPLiteralNumber_258::getStartSourceLocation() const
{
    return m_StartSourceLocation;
}

void BTPLiteralNumber_258::setStartSourceLocation(int32_t value)
{
    m_StartSourceLocation = value;
    m_StartSourceLocationIsSet = true;
}

bool BTPLiteralNumber_258::startSourceLocationIsSet() const
{
    return m_StartSourceLocationIsSet;
}

void BTPLiteralNumber_258::unsetStartSourceLocation()
{
    m_StartSourceLocationIsSet = false;
}
utility::string_t BTPLiteralNumber_258::getText() const
{
    return m_Text;
}

void BTPLiteralNumber_258::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}

bool BTPLiteralNumber_258::textIsSet() const
{
    return m_TextIsSet;
}

void BTPLiteralNumber_258::unsetText()
{
    m_TextIsSet = false;
}
double BTPLiteralNumber_258::getValue() const
{
    return m_Value;
}

void BTPLiteralNumber_258::setValue(double value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool BTPLiteralNumber_258::valueIsSet() const
{
    return m_ValueIsSet;
}

void BTPLiteralNumber_258::unsetValue()
{
    m_ValueIsSet = false;
}
}

...
BTPFunctionOrPredicateDeclaration_247::BTPFunctionOrPredicateDeclaration_247()
{
    m_NameIsSet = false;
}
...
void BTPFunctionOrPredicateDeclaration_247::validate()
{
    // TODO: implement validation
}

web::json::value BTPFunctionOrPredicateDeclaration_247::toJson() const
{
...
bool BTPFunctionOrPredicateDeclaration_247::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPFunctionOrPredicateDeclaration_247::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPFunctionOrPredicateDeclaration_247::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<BTPIdentifier_8> BTPFunctionOrPredicateDeclaration_247::getName() const
{
    return m_Name;
}

void BTPFunctionOrPredicateDeclaration_247::setName(const std::shared_ptr<BTPIdentifier_8>& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool BTPFunctionOrPredicateDeclaration_247::nameIsSet() const
{
    return m_NameIsSet;
}

void BTPFunctionOrPredicateDeclaration_247::unsetName()
{
    m_NameIsSet = false;
}
}

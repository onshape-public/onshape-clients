...
/*
 * BTPartMaterialInfo.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_BTPartMaterialInfo_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_BTPartMaterialInfo_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<BTPartMaterialPropertyInfo>>& getProperties();
    bool propertiesIsSet() const;
    void unsetProperties();

    void setProperties(const std::vector<std::shared_ptr<BTPartMaterialPropertyInfo>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<BTPartMaterialPropertyInfo>> m_Properties;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_BTPartMaterialInfo_H_ */

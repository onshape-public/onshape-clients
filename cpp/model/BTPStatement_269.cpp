...
BTPStatement_269::BTPStatement_269()
{
...
void BTPStatement_269::validate()
{
    // TODO: implement validation
}

web::json::value BTPStatement_269::toJson() const
{
...
bool BTPStatement_269::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPStatement_269::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPStatement_269::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<BTPAnnotation_231> BTPStatement_269::getAnnotation() const
{
    return m_Annotation;
}

void BTPStatement_269::setAnnotation(const std::shared_ptr<BTPAnnotation_231>& value)
{
    m_Annotation = value;
    m_AnnotationIsSet = true;
}

bool BTPStatement_269::annotationIsSet() const
{
    return m_AnnotationIsSet;
}

void BTPStatement_269::unsetAnnotation()
{
    m_AnnotationIsSet = false;
}
}

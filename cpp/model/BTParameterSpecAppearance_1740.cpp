...
#include "BTParameterSpecAppearance_1740.h"
...
BTParameterSpecAppearance_1740::BTParameterSpecAppearance_1740()
{
}
...
void BTParameterSpecAppearance_1740::validate()
{
    // TODO: implement validation
}

web::json::value BTParameterSpecAppearance_1740::toJson() const
{
...
bool BTParameterSpecAppearance_1740::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTParameterSpecAppearance_1740::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTParameterSpecAppearance_1740::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

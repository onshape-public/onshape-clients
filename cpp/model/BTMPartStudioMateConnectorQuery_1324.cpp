...
#include "BTMPartStudioMateConnectorQuery_1324.h"
...
BTMPartStudioMateConnectorQuery_1324::BTMPartStudioMateConnectorQuery_1324()
{
}
...
void BTMPartStudioMateConnectorQuery_1324::validate()
{
    // TODO: implement validation
}

web::json::value BTMPartStudioMateConnectorQuery_1324::toJson() const
{
    web::json::value val = this->BTMFeatureQueryWithOccurrence_157::toJson();
    

    return val;
}

bool BTMPartStudioMateConnectorQuery_1324::fromJson(const web::json::value& val)
{
    bool ok = true;
    ok &= this->BTMFeatureQueryWithOccurrence_157::fromJson(val);
    
    return ok;
}

void BTMPartStudioMateConnectorQuery_1324::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTMPartStudioMateConnectorQuery_1324::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

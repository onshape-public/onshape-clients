...
BTPIdentifier_8::BTPIdentifier_8()
{
...
void BTPIdentifier_8::validate()
{
    // TODO: implement validation
}

web::json::value BTPIdentifier_8::toJson() const
{
...
bool BTPIdentifier_8::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPIdentifier_8::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPIdentifier_8::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t BTPIdentifier_8::getIdentifier() const
{
    return m_Identifier;
}

void BTPIdentifier_8::setIdentifier(const utility::string_t& value)
{
    m_Identifier = value;
    m_IdentifierIsSet = true;
}

bool BTPIdentifier_8::identifierIsSet() const
{
    return m_IdentifierIsSet;
}

void BTPIdentifier_8::unsetIdentifier()
{
    m_IdentifierIsSet = false;
}
utility::string_t BTPIdentifier_8::getInvalidIdentifierForTest() const
{
    return m_InvalidIdentifierForTest;
}

void BTPIdentifier_8::setInvalidIdentifierForTest(const utility::string_t& value)
{
    m_InvalidIdentifierForTest = value;
    m_InvalidIdentifierForTestIsSet = true;
}

bool BTPIdentifier_8::invalidIdentifierForTestIsSet() const
{
    return m_InvalidIdentifierForTestIsSet;
}

void BTPIdentifier_8::unsetInvalidIdentifierForTest()
{
    m_InvalidIdentifierForTestIsSet = false;
}
}

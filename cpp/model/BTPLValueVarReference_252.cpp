...
#include "BTPLValueVarReference_252.h"
...
BTPLValueVarReference_252::BTPLValueVarReference_252()
{
    m_NameIsSet = false;
}
...
void BTPLValueVarReference_252::validate()
{
    // TODO: implement validation
}

web::json::value BTPLValueVarReference_252::toJson() const
{
...
bool BTPLValueVarReference_252::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPLValueVarReference_252::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPLValueVarReference_252::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<BTPIdentifier_8> BTPLValueVarReference_252::getName() const
{
    return m_Name;
}

void BTPLValueVarReference_252::setName(const std::shared_ptr<BTPIdentifier_8>& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool BTPLValueVarReference_252::nameIsSet() const
{
    return m_NameIsSet;
}

void BTPLValueVarReference_252::unsetName()
{
    m_NameIsSet = false;
}
}

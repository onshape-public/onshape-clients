...
#include "BTMAssemblyFeature2_1022.h"
...
BTMAssemblyFeature2_1022::BTMAssemblyFeature2_1022()
{
}
...
void BTMAssemblyFeature2_1022::validate()
{
    // TODO: implement validation
}

web::json::value BTMAssemblyFeature2_1022::toJson() const
{
...
bool BTMAssemblyFeature2_1022::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTMAssemblyFeature2_1022::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTMAssemblyFeature2_1022::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

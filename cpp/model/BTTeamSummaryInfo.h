...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_BTTeamSummaryInfo_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_BTTeamSummaryInfo_H_
...
public:
    ...
    /// 
    /// </summary>
    int32_t getPredefinedTeam() const;
    bool predefinedTeamIsSet() const;
    void unsetPredefinedTeam();

    void setPredefinedTeam(int32_t value);
...
protected:
    ...
    bool m_OwnerIsSet;
    int32_t m_PredefinedTeam;
    bool m_PredefinedTeamIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_BTTeamSummaryInfo_H_ */

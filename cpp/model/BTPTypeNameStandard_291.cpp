...
#include "BTPTypeNameStandard_291.h"
...
BTPTypeNameStandard_291::BTPTypeNameStandard_291()
{
...
void BTPTypeNameStandard_291::validate()
{
    // TODO: implement validation
}

web::json::value BTPTypeNameStandard_291::toJson() const
{
...
bool BTPTypeNameStandard_291::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPTypeNameStandard_291::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPTypeNameStandard_291::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t BTPTypeNameStandard_291::getType() const
{
    return m_Type;
}

void BTPTypeNameStandard_291::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool BTPTypeNameStandard_291::typeIsSet() const
{
    return m_TypeIsSet;
}

void BTPTypeNameStandard_291::unsetType()
{
    m_TypeIsSet = false;
}
}

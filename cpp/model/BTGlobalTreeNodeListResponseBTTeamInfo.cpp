...
BTGlobalTreeNodeListResponseBTTeamInfo::BTGlobalTreeNodeListResponseBTTeamInfo()
{
...
void BTGlobalTreeNodeListResponseBTTeamInfo::validate()
{
    // TODO: implement validation
}

web::json::value BTGlobalTreeNodeListResponseBTTeamInfo::toJson() const
{
...
bool BTGlobalTreeNodeListResponseBTTeamInfo::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t("items")))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<BTTeamInfo>> refVal_items;
...
void BTGlobalTreeNodeListResponseBTTeamInfo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTGlobalTreeNodeListResponseBTTeamInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t BTGlobalTreeNodeListResponseBTTeamInfo::getHref() const
{
    return m_Href;
}

void BTGlobalTreeNodeListResponseBTTeamInfo::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool BTGlobalTreeNodeListResponseBTTeamInfo::hrefIsSet() const
{
    return m_HrefIsSet;
}

void BTGlobalTreeNodeListResponseBTTeamInfo::unsetHref()
{
    m_HrefIsSet = false;
}
std::vector<std::shared_ptr<BTTeamInfo>>& BTGlobalTreeNodeListResponseBTTeamInfo::getItems()
{
    return m_Items;
}

void BTGlobalTreeNodeListResponseBTTeamInfo::setItems(const std::vector<std::shared_ptr<BTTeamInfo>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool BTGlobalTreeNodeListResponseBTTeamInfo::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void BTGlobalTreeNodeListResponseBTTeamInfo::unsetItems()
{
    m_ItemsIsSet = false;
}
utility::string_t BTGlobalTreeNodeListResponseBTTeamInfo::getNext() const
{
    return m_Next;
}

void BTGlobalTreeNodeListResponseBTTeamInfo::setNext(const utility::string_t& value)
{
    m_Next = value;
    m_NextIsSet = true;
}

bool BTGlobalTreeNodeListResponseBTTeamInfo::nextIsSet() const
{
    return m_NextIsSet;
}

void BTGlobalTreeNodeListResponseBTTeamInfo::unsetNext()
{
    m_NextIsSet = false;
}
utility::string_t BTGlobalTreeNodeListResponseBTTeamInfo::getPrevious() const
{
    return m_Previous;
}

void BTGlobalTreeNodeListResponseBTTeamInfo::setPrevious(const utility::string_t& value)
{
    m_Previous = value;
    m_PreviousIsSet = true;
}

bool BTGlobalTreeNodeListResponseBTTeamInfo::previousIsSet() const
{
    return m_PreviousIsSet;
}

void BTGlobalTreeNodeListResponseBTTeamInfo::unsetPrevious()
{
    m_PreviousIsSet = false;
}
}

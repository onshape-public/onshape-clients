...
BTPExpressionIs_242::BTPExpressionIs_242()
{
...
void BTPExpressionIs_242::validate()
{
    // TODO: implement validation
}

web::json::value BTPExpressionIs_242::toJson() const
{
...
bool BTPExpressionIs_242::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPExpressionIs_242::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPExpressionIs_242::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<BTPExpression_9> BTPExpressionIs_242::getOperand() const
{
    return m_Operand;
}

void BTPExpressionIs_242::setOperand(const std::shared_ptr<BTPExpression_9>& value)
{
    m_Operand = value;
    m_OperandIsSet = true;
}

bool BTPExpressionIs_242::operandIsSet() const
{
    return m_OperandIsSet;
}

void BTPExpressionIs_242::unsetOperand()
{
    m_OperandIsSet = false;
}
std::shared_ptr<BTPTypeName_290> BTPExpressionIs_242::getRTypeName() const
{
    return m_r_typeName;
}

void BTPExpressionIs_242::setRTypeName(const std::shared_ptr<BTPTypeName_290>& value)
{
    m_r_typeName = value;
    m_r_typeNameIsSet = true;
}

bool BTPExpressionIs_242::rTypeNameIsSet() const
{
    return m_r_typeNameIsSet;
}

void BTPExpressionIs_242::unsetr_typeName()
{
    m_r_typeNameIsSet = false;
}
}

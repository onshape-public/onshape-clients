...
#include "BTMParameterReferenceImage_2014.h"
...
BTMParameterReferenceImage_2014::BTMParameterReferenceImage_2014()
{
}
...
void BTMParameterReferenceImage_2014::validate()
{
    // TODO: implement validation
}

web::json::value BTMParameterReferenceImage_2014::toJson() const
{
...
bool BTMParameterReferenceImage_2014::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTMParameterReferenceImage_2014::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTMParameterReferenceImage_2014::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))

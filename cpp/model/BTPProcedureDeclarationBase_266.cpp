...
BTPProcedureDeclarationBase_266::BTPProcedureDeclarationBase_266()
{
...
void BTPProcedureDeclarationBase_266::validate()
{
    // TODO: implement validation
}

web::json::value BTPProcedureDeclarationBase_266::toJson() const
{
...
bool BTPProcedureDeclarationBase_266::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPProcedureDeclarationBase_266::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPProcedureDeclarationBase_266::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::vector<std::shared_ptr<BTPArgumentDeclaration_232>>& BTPProcedureDeclarationBase_266::getArguments()
{
    return m_Arguments;
}

void BTPProcedureDeclarationBase_266::setArguments(const std::vector<std::shared_ptr<BTPArgumentDeclaration_232>>& value)
{
    m_Arguments = value;
    m_ArgumentsIsSet = true;
}

bool BTPProcedureDeclarationBase_266::argumentsIsSet() const
{
    return m_ArgumentsIsSet;
}

void BTPProcedureDeclarationBase_266::unsetArguments()
{
    m_ArgumentsIsSet = false;
}
std::shared_ptr<BTPStatementBlock_271> BTPProcedureDeclarationBase_266::getBody() const
{
    return m_Body;
}

void BTPProcedureDeclarationBase_266::setBody(const std::shared_ptr<BTPStatementBlock_271>& value)
{
    m_Body = value;
    m_BodyIsSet = true;
}

bool BTPProcedureDeclarationBase_266::bodyIsSet() const
{
    return m_BodyIsSet;
}

void BTPProcedureDeclarationBase_266::unsetBody()
{
    m_BodyIsSet = false;
}
std::shared_ptr<BTPStatement_269> BTPProcedureDeclarationBase_266::getPrecondition() const
{
    return m_Precondition;
}

void BTPProcedureDeclarationBase_266::setPrecondition(const std::shared_ptr<BTPStatement_269>& value)
{
    m_Precondition = value;
    m_PreconditionIsSet = true;
}

bool BTPProcedureDeclarationBase_266::preconditionIsSet() const
{
    return m_PreconditionIsSet;
}

void BTPProcedureDeclarationBase_266::unsetPrecondition()
{
    m_PreconditionIsSet = false;
}
std::shared_ptr<BTPSpace_10> BTPProcedureDeclarationBase_266::getSpaceAfterArglist() const
{
    return m_SpaceAfterArglist;
}

void BTPProcedureDeclarationBase_266::setSpaceAfterArglist(const std::shared_ptr<BTPSpace_10>& value)
{
    m_SpaceAfterArglist = value;
    m_SpaceAfterArglistIsSet = true;
}

bool BTPProcedureDeclarationBase_266::spaceAfterArglistIsSet() const
{
    return m_SpaceAfterArglistIsSet;
}

void BTPProcedureDeclarationBase_266::unsetSpaceAfterArglist()
{
    m_SpaceAfterArglistIsSet = false;
}
std::shared_ptr<BTPSpace_10> BTPProcedureDeclarationBase_266::getSpaceInEmptyList() const
{
    return m_SpaceInEmptyList;
}

void BTPProcedureDeclarationBase_266::setSpaceInEmptyList(const std::shared_ptr<BTPSpace_10>& value)
{
    m_SpaceInEmptyList = value;
    m_SpaceInEmptyListIsSet = true;
}

bool BTPProcedureDeclarationBase_266::spaceInEmptyListIsSet() const
{
    return m_SpaceInEmptyListIsSet;
}

void BTPProcedureDeclarationBase_266::unsetSpaceInEmptyList()
{
    m_SpaceInEmptyListIsSet = false;
}
std::shared_ptr<BTPTypeName_290> BTPProcedureDeclarationBase_266::getReturnType() const
{
    return m_ReturnType;
}

void BTPProcedureDeclarationBase_266::setReturnType(const std::shared_ptr<BTPTypeName_290>& value)
{
    m_ReturnType = value;
    m_ReturnTypeIsSet = true;
}

bool BTPProcedureDeclarationBase_266::returnTypeIsSet() const
{
    return m_ReturnTypeIsSet;
}

void BTPProcedureDeclarationBase_266::unsetReturnType()
{
    m_ReturnTypeIsSet = false;
}
}

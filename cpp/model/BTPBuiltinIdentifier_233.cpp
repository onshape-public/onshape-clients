...
BTPBuiltinIdentifier_233::BTPBuiltinIdentifier_233()
{
...
void BTPBuiltinIdentifier_233::validate()
{
    // TODO: implement validation
}

web::json::value BTPBuiltinIdentifier_233::toJson() const
{
...
bool BTPBuiltinIdentifier_233::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BTPBuiltinIdentifier_233::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BTPBuiltinIdentifier_233::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t BTPBuiltinIdentifier_233::getIdentifier() const
{
    return m_Identifier;
}

void BTPBuiltinIdentifier_233::setIdentifier(const utility::string_t& value)
{
    m_Identifier = value;
    m_IdentifierIsSet = true;
}

bool BTPBuiltinIdentifier_233::identifierIsSet() const
{
    return m_IdentifierIsSet;
}

void BTPBuiltinIdentifier_233::unsetIdentifier()
{
    m_IdentifierIsSet = false;
}
}

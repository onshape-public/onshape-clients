...
class AssemblyDefinition:
    ...
    def get_occurrence_transforms(self, occurrence_path):
        ...
        return [occ['transform'] for occ in self.occurrences if
    ...
    def make_transform_group(self, occurrence_path):
        ...
        elif "documentMicroversion" in instance and instance["documentMicroversion"] == self.assembly_definition['rootAssembly']['documentMicroversion']:
    ...
    def is_structurally_equal_assembly(self, other):
        ...
        for occ in other.occurrences:
            ...
            for potential_occ in occurrences_to_be_matched:
                ...
                if AssemblyDefinition.is_equal_element_content(potential_instance, instance_to_match) and transform_to_match == potential_transform:
    ...
    def is_equal_element_content(this, other):
        return this['documentMicroversion'] == other['documentMicroversion'] and this['elementId'] == other[
            'elementId'] and AssemblyDefinition.compare_configurations(this["configuration"],
                                                                       other["configuration"])
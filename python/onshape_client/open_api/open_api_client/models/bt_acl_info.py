...
class BTAclInfo(object):
    ...
    def __init__(self, admin=None, inherited_acls=None, visibility=None, shared_with_support=None, entries=None, object_id=None, object_type=None, public=None, owner=None, id=None, href=None, view_ref=None, name=None):  # noqa: E501

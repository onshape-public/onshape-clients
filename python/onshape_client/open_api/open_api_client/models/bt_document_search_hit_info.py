...
class BTDocumentSearchHitInfo(object):
    ...
    def __init__(self, document_id=None, highlighted_fields=None, source_map=None, type=None, name=None, element_name=None, hit=None, version_or_workspace_name=None):  # noqa: E501

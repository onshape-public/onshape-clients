...
class BTDeviceInfo(object):
    ...
    def __init__(self, device_name=None, operating_system=None, client_type=None, device_type=None, browser=None, manufacturer=None, version=None, description=None, mobile=None):  # noqa: E501

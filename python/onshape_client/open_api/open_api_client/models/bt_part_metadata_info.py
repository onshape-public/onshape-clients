...
class BTPartMetadataInfo(object):
    ...
    def __init__(self, id=None, description=None, thumbnail_configuration_id=None, configuration_id=None, href=None, thumbnail_info=None, element_id=None, microversion_id=None, part_number=None, project=None, revision=None, custom_properties=None, vendor=None, product_line=None, title1=None, title2=None, title3=None, part_query=None, part_id=None, unflattened_part_id=None, material=None, appearance=None, custom_property_definitions=None, body_type=None, is_flattened_body=None, is_mesh=None, referencing_configured_part_node_ids=None, is_hidden=None, ordinal=None, property_source_types=None, state=None, name=None):  # noqa: E501

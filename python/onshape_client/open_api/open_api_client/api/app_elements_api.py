...
class AppElementsApi(object):
    ...
    def create7_with_http_info(self, did, wid, bt_app_element_params, **kwargs):  # noqa: E501
        ...
        if ('did' not in local_var_params or
                local_var_params['did'] is None):
            raise ApiValueError("Missing the required parameter `did` when calling `create7`")  # noqa: E501
        # verify the required parameter 'wid' is set
        if ('wid' not in local_var_params or
                local_var_params['wid'] is None):
            raise ApiValueError("Missing the required parameter `wid` when calling `create7`")  # noqa: E501
        ...
        if ('bt_app_element_params' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `bt_app_element_params` when calling `create7`")  # noqa: E501
    ...
    def create_reference1_with_http_info(self, did, eid, wvm, wvmid, bt_app_element_reference_params, **kwargs):  # noqa: E501
        ...
        if ('did' not in local_var_params or
                local_var_params['did'] is None):
            raise ApiValueError("Missing the required parameter `did` when calling `create_reference1`")  # noqa: E501
        # verify the required parameter 'eid' is set
        if ('eid' not in local_var_params or
                local_var_params['eid'] is None):
            raise ApiValueError("Missing the required parameter `eid` when calling `create_reference1`")  # noqa: E501
        # verify the required parameter 'wvm' is set
        if ('wvm' not in local_var_params or
                local_var_params['wvm'] is None):
            raise ApiValueError("Missing the required parameter `wvm` when calling `create_reference1`")  # noqa: E501
        # verify the required parameter 'wvmid' is set
        if ('wvmid' not in local_var_params or
                local_var_params['wvmid'] is None):
            raise ApiValueError("Missing the required parameter `wvmid` when calling `create_reference1`")  # noqa: E501
        ...
        if ('bt_app_element_reference_params' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `bt_app_element_reference_params` when calling `create_reference1`")  # noqa: E501
    ...
    def delete_content1_with_http_info(self, did, eid, wvm, wvmid, sid, **kwargs):  # noqa: E501
        ...
        if ('did' not in local_var_params or
                local_var_params['did'] is None):
            raise ApiValueError("Missing the required parameter `did` when calling `delete_content1`")  # noqa: E501
        # verify the required parameter 'eid' is set
        if ('eid' not in local_var_params or
                local_var_params['eid'] is None):
            raise ApiValueError("Missing the required parameter `eid` when calling `delete_content1`")  # noqa: E501
        # verify the required parameter 'wvm' is set
        if ('wvm' not in local_var_params or
                local_var_params['wvm'] is None):
            raise ApiValueError("Missing the required parameter `wvm` when calling `delete_content1`")  # noqa: E501
        # verify the required parameter 'wvmid' is set
        if ('wvmid' not in local_var_params or
                local_var_params['wvmid'] is None):
            raise ApiValueError("Missing the required parameter `wvmid` when calling `delete_content1`")  # noqa: E501
        # verify the required parameter 'sid' is set
        if ('sid' not in local_var_params or
                local_var_params['sid'] is None):
            raise ApiValueError("Missing the required parameter `sid` when calling `delete_content1`")  # noqa: E501
    ...
    def delete_reference1_with_http_info(self, did, eid, wvm, wvmid, rid, **kwargs):  # noqa: E501
        ...
        if ('did' not in local_var_params or
                local_var_params['did'] is None):
            raise ApiValueError("Missing the required parameter `did` when calling `delete_reference1`")  # noqa: E501
        # verify the required parameter 'eid' is set
        if ('eid' not in local_var_params or
                local_var_params['eid'] is None):
            raise ApiValueError("Missing the required parameter `eid` when calling `delete_reference1`")  # noqa: E501
        # verify the required parameter 'wvm' is set
        if ('wvm' not in local_var_params or
                local_var_params['wvm'] is None):
            raise ApiValueError("Missing the required parameter `wvm` when calling `delete_reference1`")  # noqa: E501
        # verify the required parameter 'wvmid' is set
        if ('wvmid' not in local_var_params or
                local_var_params['wvmid'] is None):
            raise ApiValueError("Missing the required parameter `wvmid` when calling `delete_reference1`")  # noqa: E501
        # verify the required parameter 'rid' is set
        if ('rid' not in local_var_params or
                local_var_params['rid'] is None):
            raise ApiValueError("Missing the required parameter `rid` when calling `delete_reference1`")  # noqa: E501
    ...
    def resolve_reference1_with_http_info(self, did, eid, wvm, wvmid, rid, **kwargs):  # noqa: E501
        ...
        if ('did' not in local_var_params or
                local_var_params['did'] is None):
            raise ApiValueError("Missing the required parameter `did` when calling `resolve_reference1`")  # noqa: E501
        # verify the required parameter 'eid' is set
        if ('eid' not in local_var_params or
                local_var_params['eid'] is None):
            raise ApiValueError("Missing the required parameter `eid` when calling `resolve_reference1`")  # noqa: E501
        # verify the required parameter 'wvm' is set
        if ('wvm' not in local_var_params or
                local_var_params['wvm'] is None):
            raise ApiValueError("Missing the required parameter `wvm` when calling `resolve_reference1`")  # noqa: E501
        # verify the required parameter 'wvmid' is set
        if ('wvmid' not in local_var_params or
                local_var_params['wvmid'] is None):
            raise ApiValueError("Missing the required parameter `wvmid` when calling `resolve_reference1`")  # noqa: E501
        # verify the required parameter 'rid' is set
        if ('rid' not in local_var_params or
                local_var_params['rid'] is None):
            raise ApiValueError("Missing the required parameter `rid` when calling `resolve_reference1`")  # noqa: E501
    ...
    def update5_with_http_info(self, did, eid, wvm, wvmid, bt_app_element_update_params, **kwargs):  # noqa: E501
        ...
        if ('did' not in local_var_params or
                local_var_params['did'] is None):
            raise ApiValueError("Missing the required parameter `did` when calling `update5`")  # noqa: E501
        # verify the required parameter 'eid' is set
        if ('eid' not in local_var_params or
                local_var_params['eid'] is None):
            raise ApiValueError("Missing the required parameter `eid` when calling `update5`")  # noqa: E501
        # verify the required parameter 'wvm' is set
        if ('wvm' not in local_var_params or
                local_var_params['wvm'] is None):
            raise ApiValueError("Missing the required parameter `wvm` when calling `update5`")  # noqa: E501
        # verify the required parameter 'wvmid' is set
        if ('wvmid' not in local_var_params or
                local_var_params['wvmid'] is None):
            raise ApiValueError("Missing the required parameter `wvmid` when calling `update5`")  # noqa: E501
        ...
        if ('bt_app_element_update_params' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `bt_app_element_update_params` when calling `update5`")  # noqa: E501
    ...
    def update_reference1_with_http_info(self, did, eid, wvm, wvmid, rid, bt_app_element_reference_params, **kwargs):  # noqa: E501
        ...
        if ('did' not in local_var_params or
                local_var_params['did'] is None):
            raise ApiValueError("Missing the required parameter `did` when calling `update_reference1`")  # noqa: E501
        # verify the required parameter 'eid' is set
        if ('eid' not in local_var_params or
                local_var_params['eid'] is None):
            raise ApiValueError("Missing the required parameter `eid` when calling `update_reference1`")  # noqa: E501
        # verify the required parameter 'wvm' is set
        if ('wvm' not in local_var_params or
                local_var_params['wvm'] is None):
            raise ApiValueError("Missing the required parameter `wvm` when calling `update_reference1`")  # noqa: E501
        # verify the required parameter 'wvmid' is set
        if ('wvmid' not in local_var_params or
                local_var_params['wvmid'] is None):
            raise ApiValueError("Missing the required parameter `wvmid` when calling `update_reference1`")  # noqa: E501
        # verify the required parameter 'rid' is set
        if ('rid' not in local_var_params or
                local_var_params['rid'] is None):
            raise ApiValueError("Missing the required parameter `rid` when calling `update_reference1`")  # noqa: E501
        # verify the required parameter 'bt_app_element_reference_params' is set
        if ('bt_app_element_reference_params' not in local_var_params or
                local_var_params['bt_app_element_reference_params'] is None):
            raise ApiValueError("Missing the required parameter `bt_app_element_reference_params` when calling `update_reference1`")  # noqa: E501

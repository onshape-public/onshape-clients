...
class ElementsApi(object):
    ...
    def copy_element_from_source_document1_with_http_info(self, did, wid, bt_copy_element_params, **kwargs):  # noqa: E501
        ...
        if ('did' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `did` when calling `copy_element_from_source_document1`")  # noqa: E501
        # verify the required parameter 'wid' is set
        if ('wid' not in local_var_params or
                local_var_params['wid'] is None):
            raise ApiValueError("Missing the required parameter `wid` when calling `copy_element_from_source_document1`")  # noqa: E501
        ...
        if ('bt_copy_element_params' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `bt_copy_element_params` when calling `copy_element_from_source_document1`")  # noqa: E501
    ...
    def get_configuration3_with_http_info(self, did, wvm, wvmid, eid, **kwargs):  # noqa: E501
        ...
        if ('did' not in local_var_params or
                local_var_params['did'] is None):
            raise ApiValueError("Missing the required parameter `did` when calling `get_configuration3`")  # noqa: E501
        # verify the required parameter 'wvm' is set
        if ('wvm' not in local_var_params or
                local_var_params['wvm'] is None):
            raise ApiValueError("Missing the required parameter `wvm` when calling `get_configuration3`")  # noqa: E501
        # verify the required parameter 'wvmid' is set
        if ('wvmid' not in local_var_params or
                local_var_params['wvmid'] is None):
            raise ApiValueError("Missing the required parameter `wvmid` when calling `get_configuration3`")  # noqa: E501
        # verify the required parameter 'eid' is set
        if ('eid' not in local_var_params or
                local_var_params['eid'] is None):
            raise ApiValueError("Missing the required parameter `eid` when calling `get_configuration3`")  # noqa: E501
    ...
    def get_element_translator_formats1_with_http_info(self, did, wid, eid, **kwargs):  # noqa: E501
        ...
        if ('wid' not in local_var_params or
                local_var_params['wid'] is None):
            raise ApiValueError("Missing the required parameter `wid` when calling `get_element_translator_formats1`")  # noqa: E501
        # verify the required parameter 'eid' is set
        if ('eid' not in local_var_params or
                local_var_params['eid'] is None):
    ...
    def update_configuration2_with_http_info(self, did, wvm, wvmid, eid, **kwargs):  # noqa: E501
        ...
        if ('did' not in local_var_params or
                local_var_params['did'] is None):
            raise ApiValueError("Missing the required parameter `did` when calling `update_configuration2`")  # noqa: E501
        # verify the required parameter 'wvm' is set
        if ('wvm' not in local_var_params or
                local_var_params['wvm'] is None):
            raise ApiValueError("Missing the required parameter `wvm` when calling `update_configuration2`")  # noqa: E501
        # verify the required parameter 'wvmid' is set
        if ('wvmid' not in local_var_params or
                local_var_params['wvmid'] is None):
            raise ApiValueError("Missing the required parameter `wvmid` when calling `update_configuration2`")  # noqa: E501
        # verify the required parameter 'eid' is set
        if ('eid' not in local_var_params or
                local_var_params['eid'] is None):
            raise ApiValueError("Missing the required parameter `eid` when calling `update_configuration2`")  # noqa: E501
    ...
    def update_references1_with_http_info(self, did, wid, eid, bt_update_reference_params, **kwargs):  # noqa: E501
        ...
        if ('did' not in local_var_params or
                local_var_params['did'] is None):
            raise ApiValueError("Missing the required parameter `did` when calling `update_references1`")  # noqa: E501
        # verify the required parameter 'wid' is set
        if ('wid' not in local_var_params or
                local_var_params['wid'] is None):
            raise ApiValueError("Missing the required parameter `wid` when calling `update_references1`")  # noqa: E501
        # verify the required parameter 'eid' is set
        if ('eid' not in local_var_params or
                local_var_params['eid'] is None):
            raise ApiValueError("Missing the required parameter `eid` when calling `update_references1`")  # noqa: E501
        ...
        if ('bt_update_reference_params' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `bt_update_reference_params` when calling `update_references1`")  # noqa: E501
    ...
    def upload_file2_with_http_info(self, did, **kwargs):  # noqa: E501
        ...
        if ('did' not in local_var_params or
                local_var_params['did'] is None):
            raise ApiValueError("Missing the required parameter `did` when calling `upload_file2`")  # noqa: E501

# open_api_client.AppElementsApi
...
api_instance = open_api_client.AppElementsApi(open_api_client.ApiClient(configuration))
did = 'did_example' # str | 
eid = 'eid_example' # str | 
wid = 'wid_example' # str | 
tid = 'tid_example' # str | 
bt_app_element_commit_transaction_params = open_api_client.BTAppElementCommitTransactionParams() # BTAppElementCommitTransactionParams | 
...
did = 'did_example' # str | 
wid = 'wid_example' # str | 
bt_app_element_params = open_api_client.BTAppElementParams() # BTAppElementParams | 
...
bt_app_element_reference_params = open_api_client.BTAppElementReferenceParams() # BTAppElementReferenceParams | 
...
eid = 'eid_example' # str | 
wid = 'wid_example' # str | 
bt_app_element_start_transaction_params = open_api_client.BTAppElementStartTransactionParams() # BTAppElementStartTransactionParams | 
...
wvm = 'wvm_example' # str | 
wvmid = 'wvmid_example' # str | 
bt_app_element_update_params = open_api_client.BTAppElementUpdateParams() # BTAppElementUpdateParams | 

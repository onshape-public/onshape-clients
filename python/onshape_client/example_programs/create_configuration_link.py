...
def test_create_configuration_link():
    ...
    new_config_map = {'size': 10 * u.inch, 'edge_configuration': 'chamfered', 'show_cube': True}
    element.update_current_configuration(new_config_map)
    print("Link to model with the desired configuration applied: " + element.get_url_with_configuration())
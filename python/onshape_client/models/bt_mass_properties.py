...
class BTMassProperties(object):
    ...
    def __init__(self, has_mass=None, mass_missing_count=None, mass=None, volume=None, periphery=None, centroid=None, inertia=None, export_type_name=None, connection_source=None, unknown_class=None, type_id=None):  # noqa: E501

...
class BTMoveElementParams(object):
    ...
    def __init__(self, name=None, description=None, tags=None, elements=None, owner_id=None, project_id=None, parent_id=None, target_document_id=None, owner_type=None, anchor_element_id=None, is_group_anchor=None, is_public=None, version_name=None, is_copy=None, is_deep_copy=None, source_document_id=None, source_workspace_id=None, target_workspace_id=None, generate_unknown_messages=None, import_data=None, need_new_version=None, element_original_to_new_map=None, is_new_document=None, owner_email=None):  # noqa: E501

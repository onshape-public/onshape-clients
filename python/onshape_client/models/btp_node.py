...
class BTPNode(object):
    ...
    def __init__(self, atomic=None, short_descriptor=None, start_source_location=None, end_source_location=None, documentation_type=None, first_child_field=None, changeable_child_field_indices=None, space_before=None, space_after=None, space_default=None, node_id=None, child_map_indices=None, atomic_child_indices=None, child_list_indices=None, node_id_raw=None, export_type_name=None, connection_source=None, unknown_class=None, type_id=None):  # noqa: E501

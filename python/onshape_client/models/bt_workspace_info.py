...
class BTWorkspaceInfo(object):
    ...
    def __init__(self, can_delete=None, is_read_only=None, parent=None, type=None, override_date=None, description=None, thumbnail=None, created_at=None, modified_at=None, last_modifier=None, microversion=None, document_id=None, parents=None, creator=None, name=None, id=None, view_ref=None, href=None):  # noqa: E501

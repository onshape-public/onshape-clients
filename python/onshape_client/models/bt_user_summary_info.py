...
class BTUserSummaryInfo(object):
    ...
    def __init__(self, is_light=None, last_login_time=None, source=None, first_name=None, last_name=None, email=None, is_guest=None, global_permissions=None, company=None, state=None, image=None, name=None, id=None, view_ref=None, href=None):  # noqa: E501

...
class BTUserSummaryInfo(object):
    ...
    def __init__(self, source=None, email=None, first_name=None, last_name=None, is_guest=None, is_light=None, company=None, global_permissions=None, last_login_time=None, state=None, image=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501

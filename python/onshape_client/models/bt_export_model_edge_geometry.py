...
class BTExportModelEdgeGeometry(object):
    ...
    def __init__(self, length=None, end_point=None, start_point=None, mid_point=None, quarter_point=None, start_vector=None, end_vector=None, type_id=None, connection_source=None, export_type_name=None, unknown_class=None):  # noqa: E501

...
class BTCommentInfo(object):
    ...
    def __init__(self, message=None, state=None, element_occurrences=None, assembly_features=None, resolved_at=None, reopened_at=None, assigned_at=None, user=None, attachment=None, can_resolve_or_reopen=None, can_delete=None, parent_id=None, thumbnail=None, created_at=None, workspace_id=None, element_id=None, document_id=None, version_id=None, release_package_id=None, element_query=None, element_feature=None, assignee=None, view_data=None, top_level=None, reopened_by=None, resolved_by=None, name=None, id=None, view_ref=None, href=None):  # noqa: E501

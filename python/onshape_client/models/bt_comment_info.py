...
class BTCommentInfo(object):
    ...
    def __init__(self, message=None, state=None, user=None, thumbnail=None, resolved_by=None, parent_id=None, workspace_id=None, element_id=None, can_delete=None, created_at=None, release_package_id=None, document_id=None, version_id=None, view_data=None, element_occurrences=None, assembly_features=None, element_query=None, element_feature=None, assignee=None, assigned_at=None, top_level=None, reopened_by=None, reopened_at=None, attachment=None, resolved_at=None, can_resolve_or_reopen=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501

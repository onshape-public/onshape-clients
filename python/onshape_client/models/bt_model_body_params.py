...
class BTModelBodyParams(object):
    ...
    def __init__(self, workspace_id=None, element_id=None, configuration=None, document_id=None, part_query=None, part_id=None, element_microversion_id=None):  # noqa: E501

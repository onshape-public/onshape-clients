...
class BTNotice(object):
    ...
    def __init__(self, location_infos=None, message=None, stack_trace=None, type=None, first_child_field=None, child_list_indices=None, changeable_child_field_indices=None, try_node=None, level=None, parameter_id=None, node_id=None, child_map_indices=None, atomic_child_indices=None, node_id_raw=None, export_type_name=None, connection_source=None, unknown_class=None, type_id=None):  # noqa: E501

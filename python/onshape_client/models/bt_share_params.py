...
class BTShareParams(object):
    ...
    def __init__(self, message=None, entries=None, permission=None, folder_id=None, permission_set=None, update=None, document_id=None, workspace_id=None, element_id=None, encoded_configuration=None):  # noqa: E501

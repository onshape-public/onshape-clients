...
class BTIdAndConfiguration(object):
    ...
    def __init__(self, configuration=None, id=None, configuration_is_null=None, type_id=None, export_type_name=None, unknown_class=None, connection_source=None):  # noqa: E501

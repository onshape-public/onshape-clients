...
class BTWorkflowPropertyInfo(object):
    ...
    def __init__(self, is_approver_property=None, is_notifier_property=None, name=None, default_value=None, initial_value=None, schema_id=None, ui_hints=None, dirty=None, property_source=None, validator=None, required=None, value_type=None, property_id=None, enum_values=None, editable=None):  # noqa: E501

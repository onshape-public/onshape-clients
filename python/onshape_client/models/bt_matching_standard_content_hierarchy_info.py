...
class BTMatchingStandardContentHierarchyInfo(object):
    ...
    def __init__(self, type=None, standard=None, category=None, types=None, component_document_id=None, standard_default=None, category_default=None, types_default=None, type_default=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501

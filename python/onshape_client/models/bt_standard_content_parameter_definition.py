...
class BTStandardContentParameterDefinition(object):
    ...
    def __init__(self, default_value=None, is_driving_configuration=None, visible=None, display_name=None, parameter_id=None, is_custom_parameter=None):  # noqa: E501

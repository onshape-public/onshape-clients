...
class BTStandardContentParameterDefinition(object):
    ...
    def __init__(self, default_value=None, is_custom_parameter=None, display_name=None, parameter_id=None, visible=None, is_driving_configuration=None):  # noqa: E501

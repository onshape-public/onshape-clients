...
class BTReleasePackageItemParams(object):
    ...
    def __init__(self, properties=None, id=None, href=None, part_id=None, workspace_id=None, element_id=None, configuration=None, part_number=None, version_id=None, document_id=None, is_included=None):  # noqa: E501

...
class BTCommentParams(object):
    ...
    def __init__(self, message=None, id=None, workspace_id=None, element_id=None, version_id=None, document_id=None, parent_id=None, element_query=None, element_feature=None, element_occurrence=None, assembly_feature=None, assignee=None, view_data=None):  # noqa: E501

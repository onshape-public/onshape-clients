...
class BTCommentParams(object):
    ...
    def __init__(self, message=None, id=None, parent_id=None, view_data=None, assignee=None, element_query=None, element_feature=None, element_occurrence=None, assembly_feature=None, version_id=None, document_id=None, workspace_id=None, element_id=None):  # noqa: E501

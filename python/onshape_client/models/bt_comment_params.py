...
class BTCommentParams(object):
    ...
    def __init__(self, message=None, id=None, workspace_id=None, element_id=None, parent_id=None, element_occurrence=None, assembly_feature=None, element_query=None, element_feature=None, view_data=None, assignee=None, version_id=None, document_id=None):  # noqa: E501

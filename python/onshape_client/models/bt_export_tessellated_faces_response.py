...
class BTExportTessellatedFacesResponse(object):
    ...
    def __init__(self, bodies=None, error_enum=None, facet_points=None, type_id=None, export_type_name=None, unknown_class=None, connection_source=None):  # noqa: E501

...
class BTDocumentScope(object):
    ...
    def __init__(self, workspace_id=None, element_id=None, configuration=None, version_id=None, document_id=None, document_microversion_id=None, asserted_element_type=None):  # noqa: E501

...
class BTDocumentScope(object):
    ...
    def __init__(self, document_microversion_id=None, configuration=None, version_id=None, document_id=None, workspace_id=None, element_id=None, asserted_element_type=None):  # noqa: E501

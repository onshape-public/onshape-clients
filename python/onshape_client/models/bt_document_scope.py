...
class BTDocumentScope(object):
    ...
    def __init__(self, asserted_element_type=None, configuration=None, version_id=None, document_id=None, workspace_id=None, element_id=None, document_microversion_id=None):  # noqa: E501

...
class BTInsertionLocation(object):
    ...
    def __init__(self, order_preserving=None, adjacent_to_node=None, node_id=None, node_id_raw=None, child_field_index=None, before=None, type_id=None, export_type_name=None, unknown_class=None, connection_source=None):  # noqa: E501

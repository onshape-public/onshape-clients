...
class BTPurchaseParams(object):
    ...
    def __init__(self, password=None, light_seats=None, user_id=None, email=None, plan_id=None, seats=None, domain_prefix=None, payment_type=None, trial_period_days=None, allow_deprecated_plan=None, reseller_name=None):  # noqa: E501

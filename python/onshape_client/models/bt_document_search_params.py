...
class BTDocumentSearchParams(object):
    ...
    def __init__(self, type=None, raw_query=None, offset=None, owner_id=None, when=None, found_in=None, limit=None, document_filter=None, sort_column=None, sort_order=None, parent_id=None):  # noqa: E501

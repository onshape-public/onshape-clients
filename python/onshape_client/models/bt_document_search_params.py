...
class BTDocumentSearchParams(object):
    ...
    def __init__(self, type=None, raw_query=None, offset=None, owner_id=None, parent_id=None, document_filter=None, sort_column=None, sort_order=None, limit=None, found_in=None, when=None):  # noqa: E501

...
class BTRootDiffInfo(object):
    ...
    def __init__(self, target_workspace_id=None, source_workspace_id=None, source_configuration=None, target_configuration=None, source_microversion_id=None, source_version_id=None, target_microversion_id=None, target_version_id=None, type=None, source_id=None, collection_changes=None, changes=None, target_id=None, source_value=None, target_value=None):  # noqa: E501

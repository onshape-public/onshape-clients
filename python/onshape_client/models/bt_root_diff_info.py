...
class BTRootDiffInfo(object):
    ...
    def __init__(self, source_configuration=None, target_configuration=None, source_workspace_id=None, source_version_id=None, target_version_id=None, source_microversion_id=None, target_microversion_id=None, target_workspace_id=None, type=None, changes=None, source_id=None, target_id=None, collection_changes=None, source_value=None, target_value=None):  # noqa: E501

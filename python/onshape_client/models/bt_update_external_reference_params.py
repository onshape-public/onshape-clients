...
class BTUpdateExternalReferenceParams(object):
    ...
    openapi_types = {
        ...
        'full_revision_id_to_new_revision_id': 'dict(str, str)',
    ...
    attribute_map = {
        ...
        'full_revision_id_to_new_revision_id': 'fullRevisionIdToNewRevisionId',
        'old_version_id_to_node_ids': 'oldVersionIdToNodeIds'
    }

    def __init__(self, description=None, auto_update=None, element_ids=None, old_version_id_to_new_version_id=None, full_revision_id_to_new_revision_id=None, old_version_id_to_node_ids=None):  # noqa: E501
        ...
        self._full_revision_id_to_new_revision_id = None
        ...
        if full_revision_id_to_new_revision_id is not None:
            self.full_revision_id_to_new_revision_id = full_revision_id_to_new_revision_id
    ...
    @property
    def full_revision_id_to_new_revision_id(self):
        """Gets the full_revision_id_to_new_revision_id of this BTUpdateExternalReferenceParams.  # noqa: E501


        :return: The full_revision_id_to_new_revision_id of this BTUpdateExternalReferenceParams.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._full_revision_id_to_new_revision_id

    @full_revision_id_to_new_revision_id.setter
    def full_revision_id_to_new_revision_id(self, full_revision_id_to_new_revision_id):
        """Sets the full_revision_id_to_new_revision_id of this BTUpdateExternalReferenceParams.


        :param full_revision_id_to_new_revision_id: The full_revision_id_to_new_revision_id of this BTUpdateExternalReferenceParams.  # noqa: E501
        :type: dict(str, str)
        """

        self._full_revision_id_to_new_revision_id = full_revision_id_to_new_revision_id

...
class BTRevisionCustomData(object):
    ...
    def __init__(self, valid_revision_reference=None, revision=None, part_number=None, type_id=None, export_type_name=None, unknown_class=None, connection_source=None):  # noqa: E501

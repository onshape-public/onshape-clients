...
class BTExportModelEdge(object):
    ...
    def __init__(self, id=None, curve=None, geometry=None, vertices=None, type_id=None, export_type_name=None, unknown_class=None, connection_source=None):  # noqa: E501

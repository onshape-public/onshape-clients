...
class BTBillingAccountParams(object):
    ...
    def __init__(self, address=None, reseller_name=None, force_create=None, user_id=None, password=None, plan_id=None, company_id=None, seats=None, domain_prefix=None, token=None, company_plan=None, payment_type=None, trial_period_days=None, promonthly_enabled=None, company_name=None):  # noqa: E501

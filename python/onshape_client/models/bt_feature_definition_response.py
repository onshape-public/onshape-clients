...
class BTFeatureDefinitionResponse(object):
    ...
    def __init__(self, feature=None, feature_state=None, bel_script_library_version=None, source_microversion=None, serialization_version=None, library_version=None, reject_microversion_skew=None, microversion_skew=None, type_id=None, connection_source=None, export_type_name=None, unknown_class=None):  # noqa: E501

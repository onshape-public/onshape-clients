...
class BTBillingPlanSummaryInfo(object):
    ...
    def __init__(self, hidden=None, onshape_plan=None, description=None, interval=None, company_plan=None, plan_type=None, consumable_quantity=None, amount_cents=None, application_id=None, deprecated=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501

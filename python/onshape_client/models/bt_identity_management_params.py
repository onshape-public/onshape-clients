...
class BTIdentityManagementParams(object):
    ...
    def __init__(self, name=None, enabled=None, provider_type=None, idp_certificate=None, idp_entity_id=None, idp_redirect_url=None, metadata_must_be_signed=None):  # noqa: E501

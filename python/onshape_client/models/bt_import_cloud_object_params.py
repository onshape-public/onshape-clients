...
class BTImportCloudObjectParams(object):
    ...
    def __init__(self, name=None, public=None, mime_type=None, notify_user=None, owner_type=None, url=None, cloud_storage_provider=None, owner_id=None, cloud_storage_account_id=None, cloud_object_id=None, size_bytes=None, access_token=None, foreign_id=None, upload_id=None, project_id=None, parent_id=None, update_existing_import_features=None, blob_microversion_id=None, original_foreign_id=None, blob_element_id=None, specify_units=None, split_assemblies_into_multiple_documents=None, flatten_assemblies=None, gety_axis_is_up=None, allow_faulty_parts=None, unit=None):  # noqa: E501

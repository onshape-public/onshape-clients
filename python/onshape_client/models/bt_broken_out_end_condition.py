...
class BTBrokenOutEndCondition(object):
    ...
    def __init__(self, upto_point3d=None, upto_point=None, has_upto_point=None, has_offset=None, offset_distance=None, offset_opposite_direction=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501

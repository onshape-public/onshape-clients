...
class BTElementParams(object):
    ...
    def __init__(self, location=None, is_initial_upload=None, filename=None, media_type=None, workspace_id=None, element_id=None, document_id=None, format=None, create_drawing_if_possible=None, source_document_id=None, source_workspace_id=None, notify_user=None, translate_stored_file=None, blob_microversion_id=None, blob_element_id=None, specify_units=None, project_id=None, parent_id=None, foreign_id=None, upload_id=None, split_assemblies_into_multiple_documents=None, flatten_assemblies=None, gety_axis_is_up=None, allow_faulty_parts=None, unit=None, original_foreign_id=None):  # noqa: E501

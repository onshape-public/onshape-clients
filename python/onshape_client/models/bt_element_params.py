...
class BTElementParams(object):
    ...
    def __init__(self, location=None, notify_user=None, filename=None, workspace_id=None, element_id=None, format=None, media_type=None, source_document_id=None, source_workspace_id=None, document_id=None, translate_stored_file=None, create_drawing_if_possible=None, is_initial_upload=None, project_id=None, parent_id=None, foreign_id=None, upload_id=None, specify_units=None, unit=None, original_foreign_id=None, import_within_document=None, blob_element_id=None, blob_microversion_id=None, split_assemblies_into_multiple_documents=None, flatten_assemblies=None, gety_axis_is_up=None, allow_faulty_parts=None):  # noqa: E501

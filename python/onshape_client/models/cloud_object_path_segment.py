...
class CloudObjectPathSegment(object):
    ...
    def __init__(self, cloud_storage_provider_type=None, cloud_storage_account_id=None, name=None, id=None, tree_href=None, resource_type=None, sub_type=None):  # noqa: E501

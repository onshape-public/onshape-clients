...
class BTDocumentSearchHitInfo(object):
    ...
    def __init__(self, name=None, type=None, document_id=None, highlighted_fields=None, source_map=None, version_or_workspace_name=None, hit=None, element_name=None):  # noqa: E501

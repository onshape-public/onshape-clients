...
class BTDocumentSearchHitInfo(object):
    ...
    def __init__(self, name=None, type=None, highlighted_fields=None, source_map=None, document_id=None, element_name=None, hit=None, version_or_workspace_name=None):  # noqa: E501

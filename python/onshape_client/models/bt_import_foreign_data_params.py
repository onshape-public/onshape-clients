...
class BTImportForeignDataParams(object):
    ...
    def __init__(self, size=None, owner_id=None, file_format=None, notify_user=None, filename=None, owner_type=None, media_type=None, public_document=None, document_id=None, project_id=None, parent_id=None, foreign_id=None, upload_id=None, specify_units=None, unit=None, original_foreign_id=None, import_within_document=None, blob_element_id=None, blob_microversion_id=None, split_assemblies_into_multiple_documents=None, flatten_assemblies=None, gety_axis_is_up=None, allow_faulty_parts=None):  # noqa: E501

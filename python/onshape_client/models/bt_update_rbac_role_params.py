...
class BTUpdateRbacRoleParams(object):
    ...
    @property
    def name(self):
        """Gets the name of this BTUpdateRbacRoleParams.  # noqa: E501


        :return: The name of this BTUpdateRbacRoleParams.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this BTUpdateRbacRoleParams.


        :param name: The name of this BTUpdateRbacRoleParams.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BTUpdateRbacRoleParams):
            return False

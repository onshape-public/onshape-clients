...
class BTNotificationParams(object):
    ...
    def __init__(self, id=None, event_key=None, deliver_at=None, user_id=None, acknowledged=None, expanded=None, campaign_id=None, message_id=None, message_params_array=None, notification_level=None, message_params=None):  # noqa: E501

...
class BTModelTessellationParams(object):
    ...
    def __init__(self, configuration=None, document_id=None, workspace_id=None, element_id=None, element_microversion_id=None, part_id=None, part_ids=None, part_query=None, angle_tolerance=None, chord_tolerance=None, max_facet_width=None, output_vertex_normals=None, output_facet_normals=None, output_texture_coordinates=None, output_index_table=None, entity_ids=None, output_error_faces=None):  # noqa: E501

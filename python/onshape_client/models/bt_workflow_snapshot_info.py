...
class BTWorkflowSnapshotInfo(object):
    ...
    def __init__(self, actions=None, state=None, is_frozen=None, is_setup=None, is_discarded=None, metadata_state=None, approver_ids=None, notifier_ids=None):  # noqa: E501

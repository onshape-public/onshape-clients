...
class BTUniqueDocumentItemParams(object):
    ...
    def __init__(self, element_type=None, revision=None, workspace_id=None, element_id=None, part_number=None, version_id=None, document_id=None, part_id=None, api_configuration=None):  # noqa: E501

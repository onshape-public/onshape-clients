...
class BTFSValue(object):
    ...
    def __init__(self, value_object=None, configuration_value_string=None, type_tag=None, type_id=None, export_type_name=None, unknown_class=None, connection_source=None):  # noqa: E501

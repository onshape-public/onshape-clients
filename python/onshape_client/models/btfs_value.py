...
class BTFSValue(object):
    ...
    def __init__(self, value_object=None, configuration_value_string=None, type_tag=None, type_id=None, connection_source=None, export_type_name=None, unknown_class=None):  # noqa: E501

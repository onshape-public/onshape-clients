...
class BTDocumentVersionElementIds(object):
    ...
    def __init__(self, version_id=None, document_id=None, element_id=None, type_id=None, connection_source=None, export_type_name=None, unknown_class=None):  # noqa: E501

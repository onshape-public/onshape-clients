...
class BTWebhookParams(object):
    ...
    def __init__(self, id=None, options=None, url=None, events=None, workspace_id=None, element_id=None, project_id=None, folder_id=None, filter=None, data=None, company_id=None, client_id=None, user_id=None, version_id=None, document_id=None, part_id=None):  # noqa: E501

...
class BTWebhookParams(object):
    ...
    def __init__(self, id=None, options=None, user_id=None, filter=None, url=None, events=None, data=None, folder_id=None, project_id=None, part_id=None, version_id=None, document_id=None, company_id=None, client_id=None, workspace_id=None, element_id=None):  # noqa: E501

...
class BTWebhookParams(object):
    ...
    def __init__(self, id=None, data=None, user_id=None, options=None, version_id=None, document_id=None, workspace_id=None, element_id=None, project_id=None, folder_id=None, part_id=None, filter=None, url=None, events=None, company_id=None, client_id=None):  # noqa: E501

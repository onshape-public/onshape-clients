...
class BTExportModelBody(object):
    ...
    def __init__(self, id=None, type=None, edges=None, faces=None, vertices=None, type_id=None, export_type_name=None, unknown_class=None, connection_source=None):  # noqa: E501

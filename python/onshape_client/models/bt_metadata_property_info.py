...
class BTMetadataPropertyInfo(object):
    ...
    def __init__(self, name=None, default_value=None, initial_value=None, dirty=None, required=None, property_id=None, editable=None, value_type=None, validator=None, property_source=None, schema_id=None, enum_values=None, editable_in_ui=None, ui_hints=None):  # noqa: E501

...
class BlobElementsApi(object):
    ...
    def upload_file_create_element_with_http_info(self, did, wid, **kwargs):  # noqa: E501
        ...
        all_params = ['translate','file','encodedFilename', 'did', 'wid', 'content_disposition', 'entity', 'headers', 'media_type', 'message_body_workers', 'parent', 'providers', 'body_parts', 'parameterized_headers']  # noqa: E501

...
from onshape_client.oas.models import bt_global_tree_node_list_response_bt_team_info
...
class TeamsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.find = Endpoint(
            settings={
                'response_type': (bt_global_tree_node_list_response_bt_team_info.BTGlobalTreeNodeListResponseBTTeamInfo,),
                'auth': [
                    'OAuth2'
                ],

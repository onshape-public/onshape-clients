...
class BTPlanSubscriberInfo(object):
    ...
    def __init__(self, first_name=None, last_name=None, email=None, image=None, state=None, href=None, view_ref=None, name=None, id=None, local_vars_configuration=None):  # noqa: E501

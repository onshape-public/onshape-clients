...
try:
    from onshape_client.oas.models import bt_cloud_storage_account_info_all_of
except ImportError:
    bt_cloud_storage_account_info_all_of = sys.modules['onshape_client.oas.models.bt_cloud_storage_account_info_all_of']
try:

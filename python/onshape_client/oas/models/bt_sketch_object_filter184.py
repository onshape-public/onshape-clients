...
try:
    from onshape_client.oas.models import bt_sketch_object_filter184_all_of
except ImportError:
    bt_sketch_object_filter184_all_of = sys.modules['onshape_client.oas.models.bt_sketch_object_filter184_all_of']

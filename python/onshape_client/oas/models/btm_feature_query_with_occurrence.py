...
try:
    from onshape_client.oas.models import btm_feature_query_with_occurrence_all_of
except ImportError:
    btm_feature_query_with_occurrence_all_of = sys.modules['onshape_client.oas.models.btm_feature_query_with_occurrence_all_of']
try:
...
try:
    from onshape_client.oas.models import btm_part_studio_mate_connector_query
except ImportError:
    btm_part_studio_mate_connector_query = sys.modules['onshape_client.oas.models.btm_part_studio_mate_connector_query']


class BTMFeatureQueryWithOccurrence(ModelComposed):
    ...
    def discriminator():
        return {
            'bt_type': {
                'BTMPartStudioMateConnectorQuery': btm_part_studio_mate_connector_query.BTMPartStudioMateConnectorQuery,
            },
        }
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btm_feature_query_with_occurrence.BTMFeatureQueryWithOccurrence - a model defined in OpenAPI

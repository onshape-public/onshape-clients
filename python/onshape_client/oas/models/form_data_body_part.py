...
class FormDataBodyPart(object):
    ...
    def __init__(self, content_disposition=None, entity=None, headers=None, media_type=None, message_body_workers=None, parent=None, providers=None, simple=None, form_data_content_disposition=None, name=None, value=None, parameterized_headers=None, local_vars_configuration=None):  # noqa: E501

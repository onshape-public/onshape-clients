...
class BTAssemblyPartsInfo(object):
    ...
    def __init__(self, standard_content=None, part_id=None, body_type=None, document_microversion=None, configuration=None, element_id=None, document_id=None, revision=None, full_configuration=None, document_version=None):  # noqa: E501

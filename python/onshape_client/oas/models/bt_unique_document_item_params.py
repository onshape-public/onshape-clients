...
class BTUniqueDocumentItemParams(object):
    ...
    def __init__(self, version_id=None, workspace_id=None, element_id=None, document_id=None, part_number=None, part_id=None, api_configuration=None, revision=None, element_type=None):  # noqa: E501

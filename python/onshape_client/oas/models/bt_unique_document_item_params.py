...
class BTUniqueDocumentItemParams(object):
    ...
    def __init__(self, part_number=None, part_id=None, api_configuration=None, element_type=None, version_id=None, workspace_id=None, element_id=None, document_id=None, revision=None):  # noqa: E501

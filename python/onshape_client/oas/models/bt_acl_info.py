...
class BTAclInfo(object):
    ...
    def __init__(self, admin=None, inherited_acls=None, shared_with_support=None, object_type=None, entries=None, object_id=None, visibility=None, public=None, owner=None, href=None, view_ref=None, id=None, name=None):  # noqa: E501

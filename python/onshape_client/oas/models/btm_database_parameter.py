...
try:
    from onshape_client.oas.models import btm_database_parameter_all_of
except ImportError:
    btm_database_parameter_all_of = sys.modules['onshape_client.oas.models.btm_database_parameter_all_of']
try:
...
class BTMDatabaseParameter(ModelComposed):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btm_database_parameter.BTMDatabaseParameter - a model defined in OpenAPI

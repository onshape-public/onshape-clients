...
try:
    from onshape_client.oas.models import bt_external_reference
except ImportError:
    bt_external_reference = sys.modules['onshape_client.oas.models.bt_external_reference']
try:
...
class BTElementReference(ModelNormal):
    ...
    def discriminator():
        return {
            'bt_type': {
                'BTExternalReference': bt_external_reference.BTExternalReference,
            },
        }
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """bt_element_reference.BTElementReference - a model defined in OpenAPI

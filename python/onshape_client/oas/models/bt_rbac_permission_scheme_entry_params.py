...
class BTRbacPermissionSchemeEntryParams(ModelNormal):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """bt_rbac_permission_scheme_entry_params.BTRbacPermissionSchemeEntryParams - a model defined in OpenAPI

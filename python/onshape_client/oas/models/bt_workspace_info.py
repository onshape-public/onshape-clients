...
class BTWorkspaceInfo(object):
    ...
    def __init__(self, is_read_only=None, can_delete=None, description=None, thumbnail=None, created_at=None, document_id=None, microversion=None, parents=None, modified_at=None, last_modifier=None, override_date=None, type=None, creator=None, parent=None, id=None, href=None, view_ref=None, name=None):  # noqa: E501

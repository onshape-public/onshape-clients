...
class BTWorkspaceInfo(object):
    ...
    def __init__(self, is_read_only=None, can_delete=None, microversion=None, description=None, modified_at=None, created_at=None, last_modifier=None, document_id=None, creator=None, parents=None, thumbnail=None, override_date=None, parent=None, type=None, href=None, view_ref=None, name=None, id=None):  # noqa: E501

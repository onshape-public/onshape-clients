...
class BTWorkspaceInfo(object):
    ...
    def __init__(self, is_read_only=None, can_delete=None, creator=None, thumbnail=None, created_at=None, document_id=None, microversion=None, parents=None, description=None, override_date=None, modified_at=None, last_modifier=None, parent=None, type=None, href=None, view_ref=None, name=None, id=None):  # noqa: E501

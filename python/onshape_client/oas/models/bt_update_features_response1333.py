...
try:
    from onshape_client.oas.models import bt_update_features_response1333_all_of
except ImportError:
    bt_update_features_response1333_all_of = sys.modules['onshape_client.oas.models.bt_update_features_response1333_all_of']
try:

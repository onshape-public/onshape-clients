...
class BTAppElementReferenceParams(object):
    ...
    def __init__(self, return_error=None, has_document_microversions=None, target_microversion_id=None, id_tag_microversion_id=None, id_tag=None, track_new_versions=None, sketch_ids=None, part_number=None, transaction_id=None, parent_change_id=None, revision=None, target_document_id=None, target_element_id=None, target_configuration=None, target_version_id=None, pure_sketch=None, is_sketch_only=None, update_sketch_info=None):  # noqa: E501

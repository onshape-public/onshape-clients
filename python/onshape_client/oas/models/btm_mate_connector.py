...
try:
    from onshape_client.oas.models import btm_mate_connector_all_of
except ImportError:
    btm_mate_connector_all_of = sys.modules['onshape_client.oas.models.btm_mate_connector_all_of']
try:
...
class BTMMateConnector(ModelComposed):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btm_mate_connector.BTMMateConnector - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              ...
              btm_mate_connector_all_of.BTMMateConnectorAllOf,
          ],
          'oneOf': [
          ],
        }

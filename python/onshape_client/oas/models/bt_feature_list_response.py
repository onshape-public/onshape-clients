...
class BTFeatureListResponse(object):
    ...
    def __init__(self, rollback_index=None, features=None, is_complete=None, feature_states=None, default_features=None, imports=None, microversion_skew=None, source_microversion=None, reject_microversion_skew=None, serialization_version=None, library_version=None):  # noqa: E501

...
class BTNotificationParams(object):
    ...
    def __init__(self, user_id=None, acknowledged=None, expanded=None, campaign_id=None, message_id=None, message_params_array=None, notification_level=None, deliver_at=None, event_key=None, message_params=None, id=None):  # noqa: E501

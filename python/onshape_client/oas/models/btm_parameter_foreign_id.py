...
try:
    from onshape_client.oas.models import btm_parameter_foreign_id_all_of
except ImportError:
    btm_parameter_foreign_id_all_of = sys.modules['onshape_client.oas.models.btm_parameter_foreign_id_all_of']


class BTMParameterForeignId(ModelComposed):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btm_parameter_foreign_id.BTMParameterForeignId - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              ...
              btm_parameter_foreign_id_all_of.BTMParameterForeignIdAllOf,
          ],
          'oneOf': [
          ],
        }

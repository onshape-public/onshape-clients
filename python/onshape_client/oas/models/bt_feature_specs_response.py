...
class BTFeatureSpecsResponse(object):
    ...
    def __init__(self, feature_specs=None, microversion_skew=None, source_microversion=None, reject_microversion_skew=None, serialization_version=None, library_version=None):  # noqa: E501

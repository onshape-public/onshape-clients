...
class BTMIndividualSketchRegionQueryAllOf(ModelNormal):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btm_individual_sketch_region_query_all_of.BTMIndividualSketchRegionQueryAllOf - a model defined in OpenAPI

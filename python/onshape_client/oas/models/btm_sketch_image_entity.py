...
try:
    from onshape_client.oas.models import btm_sketch_image_entity_all_of
except ImportError:
    btm_sketch_image_entity_all_of = sys.modules['onshape_client.oas.models.btm_sketch_image_entity_all_of']


class BTMSketchImageEntity(ModelComposed):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btm_sketch_image_entity.BTMSketchImageEntity - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              ...
              btm_sketch_image_entity_all_of.BTMSketchImageEntityAllOf,
          ],
          'oneOf': [
          ],
        }

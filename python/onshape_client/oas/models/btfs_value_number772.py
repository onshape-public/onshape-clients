...
try:
    from onshape_client.oas.models import btfs_value_number772_all_of
except ImportError:
    btfs_value_number772_all_of = sys.modules['onshape_client.oas.models.btfs_value_number772_all_of']

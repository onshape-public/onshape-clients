...
try:
    from onshape_client.oas.models import btp_type_name_standard
except ImportError:
    btp_type_name_standard = sys.modules['onshape_client.oas.models.btp_type_name_standard']
try:
    from onshape_client.oas.models import btp_type_name_user
except ImportError:
    btp_type_name_user = sys.modules['onshape_client.oas.models.btp_type_name_user']


class BTPTypeName(ModelNormal):
    ...
    def discriminator():
        return {
            'bt_type': {
                'BTPTypeNameUser': btp_type_name_user.BTPTypeNameUser,
                'BTPTypeNameStandard': btp_type_name_standard.BTPTypeNameStandard,
            },
        }
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btp_type_name.BTPTypeName - a model defined in OpenAPI

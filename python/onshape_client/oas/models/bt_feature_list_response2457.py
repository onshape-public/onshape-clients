...
try:
    from onshape_client.oas.models import bt_feature_list_response2457_all_of
except ImportError:
    bt_feature_list_response2457_all_of = sys.modules['onshape_client.oas.models.bt_feature_list_response2457_all_of']
try:

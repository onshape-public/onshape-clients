...
try:
    from onshape_client.oas.models import btm_feature_invalid
except ImportError:
    btm_feature_invalid = sys.modules['onshape_client.oas.models.btm_feature_invalid']
try:
    from onshape_client.oas.models import btm_parameter
except ImportError:
    btm_parameter = sys.modules['onshape_client.oas.models.btm_parameter']
try:
    from onshape_client.oas.models import btm_sketch
except ImportError:
    btm_sketch = sys.modules['onshape_client.oas.models.btm_sketch']


class BTMFeature(ModelNormal):
    ...
    def discriminator():
        return {
            'bt_type': {
                'BTMFeatureInvalid': btm_feature_invalid.BTMFeatureInvalid,
                'BTMSketch': btm_sketch.BTMSketch,
                'BTMAssemblyFeature': btm_assembly_feature.BTMAssemblyFeature,
            },
        }
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btm_feature.BTMFeature - a model defined in OpenAPI

...
try:
    from onshape_client.oas.models import btm_feature_query_with_occurrence157_all_of
except ImportError:
    btm_feature_query_with_occurrence157_all_of = sys.modules['onshape_client.oas.models.btm_feature_query_with_occurrence157_all_of']
try:
...
try:
    from onshape_client.oas.models import btm_part_studio_mate_connector_query1324
except ImportError:
    btm_part_studio_mate_connector_query1324 = sys.modules['onshape_client.oas.models.btm_part_studio_mate_connector_query1324']

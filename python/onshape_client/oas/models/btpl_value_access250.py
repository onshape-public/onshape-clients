...
try:
    from onshape_client.oas.models import btpl_value_access250_all_of
except ImportError:
    btpl_value_access250_all_of = sys.modules['onshape_client.oas.models.btpl_value_access250_all_of']

...
class BTInheritedAclInfo(object):
    ...
    def __init__(self, object_name=None, shared_with_support=None, entries=None, object_id=None, object_type=None, visibility=None, public=None, owner=None, href=None, view_ref=None, name=None, id=None, local_vars_configuration=None):  # noqa: E501

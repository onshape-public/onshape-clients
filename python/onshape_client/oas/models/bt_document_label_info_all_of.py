...
class BTDocumentLabelInfoAllOf(object):
    ...
    def __init__(self, parent_label_id=None, path=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def path(self):
        """Gets the path of this BTDocumentLabelInfoAllOf.  # noqa: E501


        :return: The path of this BTDocumentLabelInfoAllOf.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this BTDocumentLabelInfoAllOf.


        :param path: The path of this BTDocumentLabelInfoAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BTDocumentLabelInfoAllOf):
            return False

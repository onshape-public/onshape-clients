...
try:
    from onshape_client.oas.models import btm_parameter_nullable_quantity
except ImportError:
    btm_parameter_nullable_quantity = sys.modules['onshape_client.oas.models.btm_parameter_nullable_quantity']
try:
    from onshape_client.oas.models import btm_parameter_quantity_all_of
except ImportError:
    btm_parameter_quantity_all_of = sys.modules['onshape_client.oas.models.btm_parameter_quantity_all_of']


class BTMParameterQuantity(ModelComposed):
    ...
    def discriminator():
        return {
            'bt_type': {
                'BTMParameterNullableQuantity': btm_parameter_nullable_quantity.BTMParameterNullableQuantity,
            },
        }
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btm_parameter_quantity.BTMParameterQuantity - a model defined in OpenAPI

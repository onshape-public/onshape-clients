...
try:
    from onshape_client.oas.models import btp_name261_all_of
except ImportError:
    btp_name261_all_of = sys.modules["onshape_client.oas.models.btp_name261_all_of"]
try:
...
class BTPName261(ModelComposed):
    ...
    def _composed_schemas():
        ...
        return {
            "anyOf": [],
            "allOf": [btp_name261_all_of.BTPName261AllOf, btp_node7.BTPNode7,],
            "oneOf": [],
        }

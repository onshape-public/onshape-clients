...
try:
    from onshape_client.oas.models import bt_edge_topology_filter122_all_of
except ImportError:
    bt_edge_topology_filter122_all_of = sys.modules['onshape_client.oas.models.bt_edge_topology_filter122_all_of']
try:

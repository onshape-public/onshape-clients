...
class BTStandardContentHierarchyParams(object):
    ...
    def __init__(self, category=None, types=None, component_document_id=None, disable_production=None, production_version_id=None, test_version_id=None, standard=None, type=None):  # noqa: E501

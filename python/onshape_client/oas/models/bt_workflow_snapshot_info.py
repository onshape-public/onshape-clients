...
class BTWorkflowSnapshotInfo(object):
    ...
    def __init__(self, is_frozen=None, metadata_state=None, is_setup=None, is_discarded=None, actions=None, approver_ids=None, notifier_ids=None, state=None):  # noqa: E501

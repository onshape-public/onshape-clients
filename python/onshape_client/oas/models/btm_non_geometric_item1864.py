...
try:
    from onshape_client.oas.models import btm_non_geometric_item1864_all_of
except ImportError:
    btm_non_geometric_item1864_all_of = sys.modules['onshape_client.oas.models.btm_non_geometric_item1864_all_of']
try:

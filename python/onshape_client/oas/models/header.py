...
class Header(object):
    ...
    def __init__(self, description=None, getref=None, required=None, deprecated=None, style=None, explode=None, schema=None, examples=None, example=None, extensions=None, local_vars_configuration=None):  # noqa: E501

...
class BTDocumentSearchHitInfo(object):
    ...
    def __init__(self, document_id=None, highlighted_fields=None, source_map=None, type=None, name=None, element_name=None, version_or_workspace_name=None, hit=None):  # noqa: E501

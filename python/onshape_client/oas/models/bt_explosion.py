...
try:
    from onshape_client.oas.models import bt_explosion_all_of
except ImportError:
    bt_explosion_all_of = sys.modules['onshape_client.oas.models.bt_explosion_all_of']
try:
...
class BTExplosion(ModelComposed):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """bt_explosion.BTExplosion - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              bt_explosion_all_of.BTExplosionAllOf,

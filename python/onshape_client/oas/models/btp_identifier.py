...
try:
    from onshape_client.oas.models import btp_identifier_all_of
except ImportError:
    btp_identifier_all_of = sys.modules['onshape_client.oas.models.btp_identifier_all_of']
try:
...
class BTPIdentifier(ModelComposed):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btp_identifier.BTPIdentifier - a model defined in OpenAPI

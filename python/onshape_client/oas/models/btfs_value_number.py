...
try:
    from onshape_client.oas.models import btfs_value_number_all_of
except ImportError:
    btfs_value_number_all_of = sys.modules['onshape_client.oas.models.btfs_value_number_all_of']


class BTFSValueNumber(ModelComposed):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btfs_value_number.BTFSValueNumber - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              ...
              btfs_value_number_all_of.BTFSValueNumberAllOf,
          ],
          'oneOf': [
          ],
        }

...
class BTStandardContentCustomParameterDefinitionId(ModelNormal):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """bt_standard_content_custom_parameter_definition_id.BTStandardContentCustomParameterDefinitionId - a model defined in OpenAPI

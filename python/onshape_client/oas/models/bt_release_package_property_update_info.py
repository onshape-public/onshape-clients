...
class BTReleasePackagePropertyUpdateInfo(ModelNormal):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """bt_release_package_property_update_info.BTReleasePackagePropertyUpdateInfo - a model defined in OpenAPI

...
class BTMImport136(object):
    ...
    def __init__(self, element_import=None, imported_external_document_id=None, node_id=None, namespace=None, import_microversion=None, version=None, path=None, bt_type=None):  # noqa: E501

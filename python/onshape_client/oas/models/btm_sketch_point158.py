...
try:
    from onshape_client.oas.models import btm_sketch_point158_all_of
except ImportError:
    btm_sketch_point158_all_of = sys.modules['onshape_client.oas.models.btm_sketch_point158_all_of']

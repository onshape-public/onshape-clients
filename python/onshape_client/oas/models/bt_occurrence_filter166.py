...
try:
    from onshape_client.oas.models import bt_occurrence_filter166_all_of
except ImportError:
    bt_occurrence_filter166_all_of = sys.modules['onshape_client.oas.models.bt_occurrence_filter166_all_of']
try:

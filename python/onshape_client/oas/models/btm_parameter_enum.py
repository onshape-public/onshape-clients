...
try:
    from onshape_client.oas.models import btm_parameter_enum_all_of
except ImportError:
    btm_parameter_enum_all_of = sys.modules['onshape_client.oas.models.btm_parameter_enum_all_of']


class BTMParameterEnum(ModelComposed):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btm_parameter_enum.BTMParameterEnum - a model defined in OpenAPI

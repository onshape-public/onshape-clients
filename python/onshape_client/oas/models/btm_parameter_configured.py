...
try:
    from onshape_client.oas.models import btm_configured_value
except ImportError:
    btm_configured_value = sys.modules['onshape_client.oas.models.btm_configured_value']
try:
    from onshape_client.oas.models import btm_parameter
except ImportError:
    btm_parameter = sys.modules['onshape_client.oas.models.btm_parameter']
try:
    from onshape_client.oas.models import btm_parameter_configured_all_of
except ImportError:
    btm_parameter_configured_all_of = sys.modules['onshape_client.oas.models.btm_parameter_configured_all_of']


class BTMParameterConfigured(ModelComposed):
    ...
    def openapi_types():
        ...
        'values': ([btm_configured_value.BTMConfiguredValue],),  # noqa: E501
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btm_parameter_configured.BTMParameterConfigured - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            values ([btm_configured_value.BTMConfiguredValue]): [optional]  # noqa: E501
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              ...
              btm_parameter_configured_all_of.BTMParameterConfiguredAllOf,
          ],
          'oneOf': [
          ],
        }

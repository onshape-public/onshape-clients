...
class BTParameterGroupSpec3469(object):
    ...
    def __init__(self, localized_name=None, localizable_name=None, additional_localized_strings=None, strings_to_localize=None, group_name=None, group_id=None, driving_parameter_id=None, collapsed_by_default=None, group_or_parameter_ids=None, bt_type=None):  # noqa: E501

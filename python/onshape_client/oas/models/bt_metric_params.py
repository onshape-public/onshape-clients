...
class BTMetricParams(object):
    ...
    def __init__(self, element_id=None, document_id=None, event_type=None, event_name=None, event_namespace=None, event_time=None, system_id=None, property_map=None):  # noqa: E501

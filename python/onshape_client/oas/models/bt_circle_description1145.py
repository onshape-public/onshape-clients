...
try:
    from onshape_client.oas.models import bt_circle_description1145_all_of
except ImportError:
    bt_circle_description1145_all_of = sys.modules['onshape_client.oas.models.bt_circle_description1145_all_of']
try:

...
try:
    from onshape_client.oas.models import bt_plane_description692_all_of
except ImportError:
    bt_plane_description692_all_of = sys.modules['onshape_client.oas.models.bt_plane_description692_all_of']
try:

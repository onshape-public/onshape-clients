...
class BTNodeStatus(object):
    ...
    def __init__(self, error=None, status_type=None, status_enum=None, status_msg=None, faulty_parameters=None):  # noqa: E501

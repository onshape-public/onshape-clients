...
class BTPartMetadataInfo(object):
    ...
    def __init__(self, microversion_id=None, part_number=None, project=None, href=None, thumbnail_info=None, description=None, element_id=None, material=None, configuration_id=None, thumbnail_configuration_id=None, revision=None, custom_properties=None, vendor=None, product_line=None, title1=None, title2=None, title3=None, part_query=None, part_id=None, unflattened_part_id=None, custom_property_definitions=None, appearance=None, body_type=None, referencing_configured_part_node_ids=None, is_flattened_body=None, is_mesh=None, is_hidden=None, property_source_types=None, ordinal=None, state=None, id=None, name=None):  # noqa: E501

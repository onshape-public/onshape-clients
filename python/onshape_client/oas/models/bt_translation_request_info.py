...
class BTTranslationRequestInfo(object):
    ...
    def __init__(self, document_id=None, workspace_id=None, version_id=None, result_workspace_id=None, result_element_ids=None, request_state=None, result_document_id=None, failure_reason=None, request_element_id=None, result_external_data_ids=None, href=None, view_ref=None, name=None, id=None, local_vars_configuration=None):  # noqa: E501

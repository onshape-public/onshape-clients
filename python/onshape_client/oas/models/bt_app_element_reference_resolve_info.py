...
class BTAppElementReferenceResolveInfo(object):
    ...
    def __init__(self, target_element_microversion_id=None, resolved_element_microversion_id=None, part_number=None, is_sketch_only=None, is_flattened_part=None, reference_type=None, revision=None, change_id=None, id_tag=None, target_document_id=None, target_element_id=None, target_configuration=None, target_version_id=None, sketch_ids=None, is_surface=None, reference_id=None, target_document_microversion_id=None, is_configurable=None, resolved_document_microversion_id=None, id_tag_is_valid=None, track_new_versions=None, error_code=None, error_value=None, error_description=None):  # noqa: E501

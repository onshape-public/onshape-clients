...
try:
    from onshape_client.oas.models import bt_cylinder_description686_all_of
except ImportError:
    bt_cylinder_description686_all_of = sys.modules['onshape_client.oas.models.bt_cylinder_description686_all_of']
try:

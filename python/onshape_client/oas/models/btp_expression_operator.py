...
try:
    from onshape_client.oas.models import btp_expression_operator_all_of
except ImportError:
    btp_expression_operator_all_of = sys.modules['onshape_client.oas.models.btp_expression_operator_all_of']
try:
...
class BTPExpressionOperator(ModelComposed):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btp_expression_operator.BTPExpressionOperator - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              ...
              btp_expression_operator_all_of.BTPExpressionOperatorAllOf,
          ],
          'oneOf': [
          ],
        }

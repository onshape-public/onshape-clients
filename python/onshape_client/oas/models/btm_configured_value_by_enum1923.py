...
try:
    from onshape_client.oas.models import btm_configured_value_by_enum1923_all_of
except ImportError:
    btm_configured_value_by_enum1923_all_of = sys.modules['onshape_client.oas.models.btm_configured_value_by_enum1923_all_of']
try:

...
class BTFeatureScriptEvalResponse1859(object):
    ...
    def __init__(self, notices=None, console=None, result=None, microversion_skew=None, serialization_version=None, library_version=None, source_microversion=None, reject_microversion_skew=None, bt_type=None):  # noqa: E501

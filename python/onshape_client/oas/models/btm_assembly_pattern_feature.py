...
try:
    from onshape_client.oas.models import btm_assembly_pattern_feature_all_of
except ImportError:
    btm_assembly_pattern_feature_all_of = sys.modules['onshape_client.oas.models.btm_assembly_pattern_feature_all_of']
try:
...
class BTMAssemblyPatternFeature(ModelComposed):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btm_assembly_pattern_feature.BTMAssemblyPatternFeature - a model defined in OpenAPI

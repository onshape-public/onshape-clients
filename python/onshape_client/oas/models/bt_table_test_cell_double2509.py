...
try:
    from onshape_client.oas.models import bt_table_test_cell_double2509_all_of
except ImportError:
    bt_table_test_cell_double2509_all_of = sys.modules['onshape_client.oas.models.bt_table_test_cell_double2509_all_of']

...
try:
    from onshape_client.oas.models import btm_individual_sketch_region_query140_all_of
except ImportError:
    btm_individual_sketch_region_query140_all_of = sys.modules['onshape_client.oas.models.btm_individual_sketch_region_query140_all_of']
try:

...
try:
    from onshape_client.oas.models import bt_section_plane_info
except ImportError:
    bt_section_plane_info = sys.modules[
        "onshape_client.oas.models.bt_section_plane_info"
    ]
...
class BTNamedViewInfo(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "section_planes": (
                [bt_section_plane_info.BTSectionPlaneInfo],
            ),  # noqa: E501

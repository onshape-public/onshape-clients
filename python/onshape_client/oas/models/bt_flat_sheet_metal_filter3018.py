...
try:
    from onshape_client.oas.models import bt_flat_sheet_metal_filter3018_all_of
except ImportError:
    bt_flat_sheet_metal_filter3018_all_of = sys.modules['onshape_client.oas.models.bt_flat_sheet_metal_filter3018_all_of']
try:

...
class BTElementReference725(object):
    ...
    def __init__(self, element_id=None, microversion_id_and_configuration=None, external_document_with_version_and_element_id=None, external_document_with_version=None, external_reference=None, configured=None, full_element_id=None, node_id=None, bt_type=None):  # noqa: E501

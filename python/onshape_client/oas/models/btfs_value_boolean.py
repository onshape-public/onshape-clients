...
try:
    from onshape_client.oas.models import btfs_value_boolean_all_of
except ImportError:
    btfs_value_boolean_all_of = sys.modules['onshape_client.oas.models.btfs_value_boolean_all_of']


class BTFSValueBoolean(ModelComposed):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btfs_value_boolean.BTFSValueBoolean - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              ...
              btfs_value_boolean_all_of.BTFSValueBooleanAllOf,
          ],
          'oneOf': [
          ],
        }

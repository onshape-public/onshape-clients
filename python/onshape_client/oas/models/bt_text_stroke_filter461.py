...
try:
    from onshape_client.oas.models import bt_text_stroke_filter461_all_of
except ImportError:
    bt_text_stroke_filter461_all_of = sys.modules['onshape_client.oas.models.bt_text_stroke_filter461_all_of']

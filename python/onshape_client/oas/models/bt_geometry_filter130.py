...
try:
    from onshape_client.oas.models import bt_geometry_filter130_all_of
except ImportError:
    bt_geometry_filter130_all_of = sys.modules['onshape_client.oas.models.bt_geometry_filter130_all_of']
try:

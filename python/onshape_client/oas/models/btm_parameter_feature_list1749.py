...
try:
    from onshape_client.oas.models import btm_parameter_feature_list1749_all_of
except ImportError:
    btm_parameter_feature_list1749_all_of = sys.modules['onshape_client.oas.models.btm_parameter_feature_list1749_all_of']

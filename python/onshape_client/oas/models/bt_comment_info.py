...
class BTCommentInfo(object):
    ...
    def __init__(self, parent_id=None, thumbnail=None, created_at=None, document_id=None, version_id=None, element_id=None, workspace_id=None, release_package_id=None, view_data=None, user=None, can_delete=None, resolved_by=None, assignee=None, element_occurrences=None, assembly_features=None, assigned_at=None, resolved_at=None, reopened_at=None, attachment=None, state=None, can_resolve_or_reopen=None, message=None, element_query=None, element_feature=None, top_level=None, reopened_by=None, id=None, href=None, view_ref=None, name=None):  # noqa: E501

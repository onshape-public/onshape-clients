...
try:
    from onshape_client.oas.models import bt_allow_edge_point_filter2371_all_of
except ImportError:
    bt_allow_edge_point_filter2371_all_of = sys.modules['onshape_client.oas.models.bt_allow_edge_point_filter2371_all_of']
try:

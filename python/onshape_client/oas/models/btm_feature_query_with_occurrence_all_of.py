...
class BTMFeatureQueryWithOccurrenceAllOf(ModelNormal):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btm_feature_query_with_occurrence_all_of.BTMFeatureQueryWithOccurrenceAllOf - a model defined in OpenAPI

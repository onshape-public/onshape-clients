...
try:
    from onshape_client.oas.models import btp_expression_switch2632_all_of
except ImportError:
    btp_expression_switch2632_all_of = sys.modules['onshape_client.oas.models.btp_expression_switch2632_all_of']
try:

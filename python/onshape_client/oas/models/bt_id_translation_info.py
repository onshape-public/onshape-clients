...
class BTIdTranslationInfo(object):
    ...
    def __init__(self, document_id=None, element_id=None, ids=None, source_document_microversion=None, target_document_microversion=None, local_vars_configuration=None):  # noqa: E501

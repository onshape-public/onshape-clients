...
try:
    from onshape_client.oas.models import bt_curve_geometry_line117_all_of
except ImportError:
    bt_curve_geometry_line117_all_of = sys.modules['onshape_client.oas.models.bt_curve_geometry_line117_all_of']

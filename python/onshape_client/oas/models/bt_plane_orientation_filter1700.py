...
try:
    from onshape_client.oas.models import bt_plane_orientation_filter1700_all_of
except ImportError:
    bt_plane_orientation_filter1700_all_of = sys.modules['onshape_client.oas.models.bt_plane_orientation_filter1700_all_of']
try:

...
class Coupon(object):
    ...
    def __init__(self, id=None, object=None, amount_off=None, created=None, currency=None, duration=None, duration_in_months=None, livemode=None, max_redemptions=None, metadata=None, percent_off=None, redeem_by=None, times_redeemed=None, valid=None, local_vars_configuration=None):  # noqa: E501

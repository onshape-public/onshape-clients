...
try:
    from onshape_client.oas.models import bt_parameter_spec_reference_assembly2821
except ImportError:
    bt_parameter_spec_reference_assembly2821 = sys.modules['onshape_client.oas.models.bt_parameter_spec_reference_assembly2821']
try:
    from onshape_client.oas.models import bt_parameter_spec_reference_blob1367
except ImportError:
    bt_parameter_spec_reference_blob1367 = sys.modules['onshape_client.oas.models.bt_parameter_spec_reference_blob1367']
try:
    from onshape_client.oas.models import bt_parameter_spec_reference_part_studio1256
except ImportError:
    bt_parameter_spec_reference_part_studio1256 = sys.modules['onshape_client.oas.models.bt_parameter_spec_reference_part_studio1256']
try:
    from onshape_client.oas.models import bt_parameter_spec_reference_with_configuration2950
except ImportError:
    bt_parameter_spec_reference_with_configuration2950 = sys.modules['onshape_client.oas.models.bt_parameter_spec_reference_with_configuration2950']
try:

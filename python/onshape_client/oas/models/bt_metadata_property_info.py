...
class BTMetadataPropertyInfo(object):
    ...
    def __init__(self, required=None, property_id=None, editable=None, value_type=None, schema_id=None, validator=None, enum_values=None, initial_value=None, editable_in_ui=None, property_source=None, ui_hints=None, dirty=None, value=None, name=None):  # noqa: E501

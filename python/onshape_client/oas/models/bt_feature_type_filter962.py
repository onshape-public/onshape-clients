...
try:
    from onshape_client.oas.models import bt_feature_type_filter962_all_of
except ImportError:
    bt_feature_type_filter962_all_of = sys.modules['onshape_client.oas.models.bt_feature_type_filter962_all_of']
try:

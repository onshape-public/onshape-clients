...
try:
    from onshape_client.oas.models import bt_parameter_spec_string175_all_of
except ImportError:
    bt_parameter_spec_string175_all_of = sys.modules['onshape_client.oas.models.bt_parameter_spec_string175_all_of']
try:

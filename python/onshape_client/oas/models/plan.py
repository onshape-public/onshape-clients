...
class Plan(object):
    ...
    def __init__(self, id=None, object=None, amount=None, created=None, currency=None, interval=None, interval_count=None, livemode=None, metadata=None, name=None, statement_descriptor=None, trial_period_days=None, statement_description=None, local_vars_configuration=None):  # noqa: E501

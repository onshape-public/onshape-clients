...
try:
    from onshape_client.oas.models import btp_literal_array_all_of
except ImportError:
    btp_literal_array_all_of = sys.modules['onshape_client.oas.models.btp_literal_array_all_of']
try:
...
class BTPLiteralArray(ModelComposed):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btp_literal_array.BTPLiteralArray - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              ...
              btp_literal_array_all_of.BTPLiteralArrayAllOf,
          ],
          'oneOf': [
          ],
        }

...
class BTInsertableInfo(object):
    ...
    def __init__(self, is_mesh=None, data_type=None, microversion_id=None, document_id=None, element_id=None, parent_id=None, version_name=None, version_id=None, element_type=None, deterministic_id=None, body_type=None, is_flattened_body=None, insertable_query=None, feature_spec=None, feature_type=None, feature_name=None, class_type=None, feature_id=None, element_name=None, part_name=None, configuration_parameters=None, configuration_parameter_values=None, unflattened_part_deterministic_id=None, has_faults=None, thumbnail_uri=None, configuration_id=None, predictable_id=None, href=None, view_ref=None, name=None, id=None, local_vars_configuration=None):  # noqa: E501

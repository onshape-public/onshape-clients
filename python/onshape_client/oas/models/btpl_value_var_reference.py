...
try:
    from onshape_client.oas.models import btpl_value_var_reference_all_of
except ImportError:
    btpl_value_var_reference_all_of = sys.modules['onshape_client.oas.models.btpl_value_var_reference_all_of']


class BTPLValueVarReference(ModelComposed):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """btpl_value_var_reference.BTPLValueVarReference - a model defined in OpenAPI

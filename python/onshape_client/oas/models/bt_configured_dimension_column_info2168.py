...
try:
    from onshape_client.oas.models import bt_configured_dimension_column_info2168_all_of
except ImportError:
    bt_configured_dimension_column_info2168_all_of = sys.modules['onshape_client.oas.models.bt_configured_dimension_column_info2168_all_of']
try:

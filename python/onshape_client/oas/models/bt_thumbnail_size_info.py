...
class BTThumbnailSizeInfo(object):
    ...
    def __init__(self, unique_id=None, href=None, render_mode=None, media_type=None, view_orientation=None, sheet_name=None, size=None, local_vars_configuration=None):  # noqa: E501

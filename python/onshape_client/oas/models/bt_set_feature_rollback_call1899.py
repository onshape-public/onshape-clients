...
try:
    from onshape_client.oas.models import bt_set_feature_rollback_call1899_all_of
except ImportError:
    bt_set_feature_rollback_call1899_all_of = sys.modules['onshape_client.oas.models.bt_set_feature_rollback_call1899_all_of']

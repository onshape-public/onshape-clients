...
class BTElementParams(object):
    ...
    def __init__(self, filename=None, workspace_id=None, element_id=None, document_id=None, source_document_id=None, source_workspace_id=None, media_type=None, notify_user=None, translate_stored_file=None, create_drawing_if_possible=None, is_initial_upload=None, format=None, location=None, project_id=None, parent_id=None, foreign_id=None, upload_id=None, unit=None, specify_units=None, split_assemblies_into_multiple_documents=None, flatten_assemblies=None, gety_axis_is_up=None, allow_faulty_parts=None, create_composite=None, original_foreign_id=None, import_within_document=None, blob_element_id=None, blob_microversion_id=None, processed_foreign_id=None):  # noqa: E501

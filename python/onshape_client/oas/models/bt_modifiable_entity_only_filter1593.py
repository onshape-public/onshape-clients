...
try:
    from onshape_client.oas.models import bt_modifiable_entity_only_filter1593_all_of
except ImportError:
    bt_modifiable_entity_only_filter1593_all_of = sys.modules['onshape_client.oas.models.bt_modifiable_entity_only_filter1593_all_of']
try:

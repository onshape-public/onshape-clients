...
class BTUpdateExternalReferenceParams(object):
    ...
    def __init__(self, auto_update=None, element_ids=None, old_version_id_to_node_ids=None, old_version_id_to_new_version_id=None, full_revision_id_to_new_revision_id=None, description=None):  # noqa: E501

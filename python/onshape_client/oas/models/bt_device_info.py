...
class BTDeviceInfo(object):
    ...
    def __init__(self, client_type=None, device_name=None, operating_system=None, device_type=None, browser=None, manufacturer=None, mobile=None, version=None, description=None):  # noqa: E501

...
class BTOwnerInfo(object):
    ...
    def __init__(self, image=None, is_enterprise_owned_resource=None, accept_ownership_transfer=None, type=None, href=None, view_ref=None, name=None, id=None, local_vars_configuration=None):  # noqa: E501

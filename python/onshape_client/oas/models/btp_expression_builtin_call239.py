...
try:
    from onshape_client.oas.models import btp_expression_builtin_call239_all_of
except ImportError:
    btp_expression_builtin_call239_all_of = sys.modules['onshape_client.oas.models.btp_expression_builtin_call239_all_of']
try:

...
try:
    from onshape_client.oas.models import btp_expression_try1271_all_of
except ImportError:
    btp_expression_try1271_all_of = sys.modules['onshape_client.oas.models.btp_expression_try1271_all_of']
try:

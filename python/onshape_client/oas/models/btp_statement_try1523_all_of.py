...
class BTPStatementTry1523AllOf(object):
    ...
    def __init__(self, standard_type=None, name=None, type_name=None, body=None, silent=None, catch_variable=None, space_before_silent=None, catch_block=None, space_after_catch=None):  # noqa: E501

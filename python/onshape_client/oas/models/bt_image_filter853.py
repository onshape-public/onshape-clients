...
try:
    from onshape_client.oas.models import bt_image_filter853_all_of
except ImportError:
    bt_image_filter853_all_of = sys.modules['onshape_client.oas.models.bt_image_filter853_all_of']
try:

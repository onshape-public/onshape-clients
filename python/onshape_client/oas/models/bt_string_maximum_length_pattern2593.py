...
try:
    from onshape_client.oas.models import bt_string_maximum_length_pattern2593_all_of
except ImportError:
    bt_string_maximum_length_pattern2593_all_of = sys.modules['onshape_client.oas.models.bt_string_maximum_length_pattern2593_all_of']

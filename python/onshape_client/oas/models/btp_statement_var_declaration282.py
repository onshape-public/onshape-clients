...
try:
    from onshape_client.oas.models import btp_statement_constant_declaration273_all_of
except ImportError:
    btp_statement_constant_declaration273_all_of = sys.modules['onshape_client.oas.models.btp_statement_constant_declaration273_all_of']
try:

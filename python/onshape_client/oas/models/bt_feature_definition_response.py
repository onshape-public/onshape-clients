...
class BTFeatureDefinitionResponse(object):
    ...
    def __init__(self, feature_state=None, feature=None, microversion_skew=None, source_microversion=None, reject_microversion_skew=None, serialization_version=None, library_version=None):  # noqa: E501
